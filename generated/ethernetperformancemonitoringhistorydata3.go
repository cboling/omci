...
func init() {
	ethernetperformancemonitoringhistorydata3BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			8:  Uint32Field("UndersizePackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint32Field("Fragments", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint32Field("Jabbers", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
