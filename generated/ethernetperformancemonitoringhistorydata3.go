...
func init() {
	ethernetperformancemonitoringhistorydata3BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			8:  Uint32Field("UndersizePackets", 0, Read, false, false, false, 8),
			9:  Uint32Field("Fragments", 0, Read, false, false, false, 9),
			10: Uint32Field("Jabbers", 0, Read, false, false, false, 10),
