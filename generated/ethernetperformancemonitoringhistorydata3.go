...
func init() {
	ethernetperformancemonitoringhistorydata3BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			8:  Uint32Field("UndersizePackets", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint32Field("Fragments", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("Jabbers", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
