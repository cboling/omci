...
func init() {
	xdslxturperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  Uint16Field("LossOfPowerSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint16Field("ErroredSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint16Field("SeverelyErroredSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint16Field("FecSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint16Field("UnavailableSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint16Field("LeftrDefectSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 10),
			11: Uint32Field("ErrorFreeBitsCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 11),
			12: Uint32Field("MinimumErrorFreeThroughputMineftr", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 12),
		},
		Access:  CreatedByOlt,
