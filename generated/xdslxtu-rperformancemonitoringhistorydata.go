...
func init() {
	xdslxturperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  Uint16Field("LossOfPowerSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint16Field("ErroredSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint16Field("SeverelyErroredSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint16Field("FecSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint16Field("UnavailableSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint16Field("LeftrDefectSeconds", 0, mapset.NewSetWith(Read), false, true, true, false, 10),
