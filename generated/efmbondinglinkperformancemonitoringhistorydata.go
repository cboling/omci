...
func init() {
	efmbondinglinkperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("RxErroredFragments", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  Uint32Field("RxSmallFragments", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  Uint32Field("RxLargeFragments", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint32Field("RxDiscardedFragments", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint32Field("RxFcsErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint32Field("RxCodingErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint32Field("RxFragments", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint32Field("TxFragments", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
		},
		Access:  CreatedByOlt,
