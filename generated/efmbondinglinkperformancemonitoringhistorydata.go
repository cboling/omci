...
func init() {
	efmbondinglinkperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("RxErroredFragments", 0, Read, false, false, false, 3),
			4:  Uint32Field("RxSmallFragments", 0, Read, false, false, false, 4),
			5:  Uint32Field("RxLargeFragments", 0, Read, false, false, false, 5),
			6:  Uint32Field("RxDiscardedFragments", 0, Read, false, false, false, 6),
			7:  Uint32Field("RxFcsErrors", 0, Read, false, false, false, 7),
			8:  Uint32Field("RxCodingErrors", 0, Read, false, false, false, 8),
			9:  Uint32Field("RxFragments", 0, Read, false, false, false, 9),
			10: Uint32Field("TxFragments", 0, Read, false, false, false, 10),
		},
	}
}
