...
func init() {
	voiplinestatusBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: Uint16Field("VoipCodecUsed", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 1),
			2: ByteField("VoipVoiceServerStatus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 2),
			3: ByteField("VoipPortSessionType", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint16Field("VoipCall1PacketPeriod", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint16Field("VoipCall2PacketPeriod", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6: MultiByteField("VoipCall1DestAddr", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read), false, false, 6),
			7: MultiByteField("VoipCall2DestAddr", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read), false, false, 7),
			8: ByteField("VoipLineState", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 8),
			9: ByteField("EmergencyCallStatus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), true, true, 9),
		},
		Access:  CreatedByOnu,
