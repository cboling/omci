...
func init() {
	voiplinestatusBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			6: MultiByteField("VoipCall1DestAddr", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read), false, false, false, 6),
			7: MultiByteField("VoipCall2DestAddr", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read), false, false, false, 7),
