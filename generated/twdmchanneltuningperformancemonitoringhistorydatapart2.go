...
func init() {
	twdmchanneltuningperformancemonitoringhistorydatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("TuningControlRequestsRejectedDsAlbl", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  Uint32Field("TuningControlRequestsRejectedDsVoid", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  Uint32Field("TuningControlRequestsRejectedDsPart", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint32Field("TuningControlRequestsRejectedDsTunr", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint32Field("TuningControlRequestsRejectedDsLnrt", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint32Field("TuningControlRequestsRejectedDsLncd", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint32Field("TuningControlRequestsRejectedUsAlbl", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint32Field("TuningControlRequestsRejectedUsVoid", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
			11: Uint32Field("TuningControlRequestsRejectedUsTunr", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 11),
			12: Uint32Field("TuningControlRequestsRejectedUsClbr", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 12),
			13: Uint32Field("TuningControlRequestsRejectedUsLktp", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 13),
			14: Uint32Field("TuningControlRequestsRejectedUsLnrt", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 14),
			15: Uint32Field("TuningControlRequestsRejectedUsLncd", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 15),
		},
		Access:  CreatedByOlt,
