...
func init() {
	physicalpathterminationpointpotsuniBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("AdministrativeState", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), true, false, false, 1),
			2:  Uint16Field("Deprecated", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, true, 2),
			...
			5:  ByteField("Impedance", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 5),
			6:  ByteField("TransmissionPath", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 6),
			7:  ByteField("RxGain", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 7),
			8:  ByteField("TxGain", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 8),
			9:  ByteField("OperationalState", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), true, true, false, 9),
			10: ByteField("HookState", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 10),
			11: Uint16Field("PotsHoldoverTime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 11),
			12: ByteField("NominalFeedVoltage", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 12),
			13: ByteField("LossOfSoftswitch", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 13),
		},
		Access:  CreatedByOnu,
