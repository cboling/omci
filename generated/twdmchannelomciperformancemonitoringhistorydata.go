...
func init() {
	twdmchannelomciperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("OmciBaselineMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint32Field("OmciExtendedMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: Uint32Field("OmciMicErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
		},
		Access:  CreatedByOlt,
