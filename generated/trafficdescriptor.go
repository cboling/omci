...
func init() {
	trafficdescriptorBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: Uint32Field("Cir", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 1),
			2: Uint32Field("Pir", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 2),
			3: Uint32Field("Cbs", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 3),
			4: Uint32Field("Pbs", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 4),
			5: ByteField("ColourMode", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 5),
			6: ByteField("IngressColourMarking", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 6),
			7: ByteField("EgressColourMarking", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 7),
			8: ByteField("MeterType", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate), false, true, 8),
		},
		Access:  CreatedByOlt,
