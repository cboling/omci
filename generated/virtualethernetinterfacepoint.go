...
func init() {
	virtualethernetinterfacepointBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: MultiByteField("InterdomainName", 25, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=="), mapset.NewSetWith(Read, Write), false, false, true, false, 3),
			4: Uint16Field("TcpUdpPointer", 0, mapset.NewSetWith(Read, Write), false, false, true, false, 4),
			5: Uint16Field("IanaAssignedPort", 65535, mapset.NewSetWith(Read), false, false, false, false, 5),
		},
		Access:  CreatedByOnu,
