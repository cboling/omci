...
func init() {
	efmbondingportperformancemonitoringhistorydatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  Uint32Field("RxUnicastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  Uint32Field("TxUnicastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			...
			9:  Uint32Field("RxBroadcastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint32Field("TxBroadcastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			...
			13: Uint32Field("RxMulticastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 13),
			14: Uint32Field("TxMulticastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 14),
		},
		Access:  CreatedByOlt,
