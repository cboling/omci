...
func init() {
	efmbondingportperformancemonitoringhistorydatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("RxUnicastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4:  Uint32Field("TxUnicastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5:  Uint32Field("RxUnicastBytes", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint32Field("TxUnicastBytes", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("RxBroadcastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint32Field("TxBroadcastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint32Field("RxBroadcastBytes", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("TxBroadcastBytes", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint32Field("RxMulticastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
			12: Uint32Field("TxMulticastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 12),
			13: Uint32Field("RxMulticastBytes", 0, mapset.NewSetWith(Read), false, true, false, false, 13),
			14: Uint32Field("TxMulticastBytes", 0, mapset.NewSetWith(Read), false, true, false, false, 14),
		},
		Access:  CreatedByOlt,
