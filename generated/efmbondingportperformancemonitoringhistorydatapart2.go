...
func init() {
	efmbondingportperformancemonitoringhistorydatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("RxUnicastFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  Uint32Field("TxUnicastFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  Uint32Field("RxUnicastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint32Field("TxUnicastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint32Field("RxBroadcastFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint32Field("TxBroadcastFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint32Field("RxBroadcastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint32Field("TxBroadcastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
			11: Uint32Field("RxMulticastFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 11),
			12: Uint32Field("TxMulticastFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 12),
			13: Uint32Field("RxMulticastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 13),
			14: Uint32Field("TxMulticastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 14),
		},
		Access:  CreatedByOlt,
