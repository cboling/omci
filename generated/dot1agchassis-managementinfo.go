...
func init() {
	dot1agchassismanagementinfoBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("ChassisIdLength", 0, mapset.NewSetWith(Read, Write), false, false, false, false, 1),
			2: ByteField("ChassisIdSubtype", 0, mapset.NewSetWith(Read, Write), false, false, false, false, 2),
			3: MultiByteField("ChassisIdPart1ChassisIdPart2", 25, nil, mapset.NewSetWith(Read, Write), false, false, false, false, 3),
			4: ByteField("ManagementAddressDomainLength", 0, mapset.NewSetWith(Read, Write), false, false, false, false, 4),
			5: MultiByteField("ManagementAddressDomain1,ManagementAddressDomain2", 25, nil, mapset.NewSetWith(Read, Write), false, false, false, false, 5),
