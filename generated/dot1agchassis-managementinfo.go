...
func init() {
	dot1agchassismanagementinfoBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("ChassisIdLength", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			2: ByteField("ChassisIdSubtype", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
			3: MultiByteField("ChassisIdPart1ChassisIdPart2", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, 3),
			4: ByteField("ManagementAddressDomainLength", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 4),
			5: MultiByteField("ManagementAddressDomain1,ManagementAddressDomain2", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, 5),
			6: ByteField("ManagementAddressLength", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 6),
			7: MultiByteField("ManagementAddress1ManagementAddress2", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, 7),
		},
		Access:  CreatedByOnu,
