...
func init() {
	trafficschedulerBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: Uint16Field("TContPointer", PointerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			2: Uint16Field("TrafficSchedulerPointer", PointerAttributeType, 0, mapset.NewSetWith(Read), false, false, 2),
			3: ByteField("Policy", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4: ByteField("PriorityWeight", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 4),
		},
		Access:  CreatedByOnu,
