...
func init() {
	fastvectoringlineconfigurationextensionsBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("FextCancellationEnablingDisablingUpstreamFextToCancelEnableus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			2: ByteField("FextCancellationEnablingDisablingDownstreamFextToCancelEnableds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
		},
		Access:  CreatedByOlt,
