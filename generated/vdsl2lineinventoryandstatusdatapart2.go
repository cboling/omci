...
func init() {
	vdsl2lineinventoryandstatusdatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("Vdsl2TransmissionSystemCapabilityXtuR", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 1),
			2:  ByteField("Actsnrmodeus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 2),
			3:  Uint16Field("Upbokle", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4:  ByteField("Hlingus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  ByteField("Hloggus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  ByteField("Qlngus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  ByteField("Snrgus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  TableField("MrefpsdusTable", TableAttributeType, TableInfo{nil, 3}, mapset.NewSetWith(Read), false, false, false, 8),
			9:  ByteField("Trellisus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: ByteField("Actualce", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: Uint16Field("UpbokleR", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 11),
			12: ByteField("ActualRateAdaptationModeUpstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 12),
			13: ByteField("ActualImpulseNoiseProtectionRocUpstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 13),
			14: Uint16Field("SnrMarginRocUpstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 14),
		},
		Access:  CreatedByOnu,
