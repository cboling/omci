...
func init() {
	voipconfigdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("AvailableSignallingProtocols", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 1),
			2: ByteField("SignallingProtocolUsed", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
			3: Uint32Field("AvailableVoipConfigurationMethods", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: ByteField("VoipConfigurationMethodUsed", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 4),
			5: Uint16Field("VoipConfigurationAddressPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
			6: ByteField("VoipConfigurationState", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7: ByteField("RetrieveProfile", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Write), false, false, 7),
			8: MultiByteField("ProfileVersion", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read), true, false, 8),
		},
		Access:  CreatedByOnu,
