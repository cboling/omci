...
func init() {
	energyconsumptionperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("DozeTime", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint32Field("CyclicSleepTime", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint32Field("WatchfulSleepTime", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6: Uint32Field("EnergyConsumed", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 6),
		},
		Access:  CreatedByOlt,
