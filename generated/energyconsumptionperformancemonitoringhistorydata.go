...
func init() {
	energyconsumptionperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("DozeTime", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint32Field("CyclicSleepTime", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
