...
func init() {
	redownstreamamplifierBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  ByteField("OperationalMode", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 5),
			6:  Uint16Field("InputOpticalSignalLevel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 6),
			7:  ByteField("LowerInputOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 7),
			8:  ByteField("UpperInputOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 8),
			9:  Uint16Field("OutputOpticalSignalLevel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 9),
			10: ByteField("LowerOutputOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 10),
			11: ByteField("UpperOutputOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 11),
			12: ByteField("R'S'SplitterCouplingRatio", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 12),
		},
		Access:  CreatedByOnu,
