...
func init() {
	efmbondinggroupperformancemonitoringhistorydatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  Uint64Field("RxUnicastBytes", 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  Uint64Field("TxUnicastBytes", 0, mapset.NewSetWith(Read), false, false, false, 6),
			...
			9:  Uint64Field("RxBroadcastBytes", 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint64Field("TxBroadcastBytes", 0, mapset.NewSetWith(Read), false, false, false, 10),
			...
			13: Uint64Field("RxMulticastBytes", 0, mapset.NewSetWith(Read), false, false, false, 13),
			14: Uint64Field("TxMulticastBytes", 0, mapset.NewSetWith(Read), false, false, false, 14),
		},
	}
}
