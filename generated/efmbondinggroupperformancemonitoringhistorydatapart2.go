...
func init() {
	efmbondinggroupperformancemonitoringhistorydatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  Uint64Field("RxUnicastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint64Field("TxUnicastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			...
			9:  Uint64Field("RxBroadcastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint64Field("TxBroadcastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
			...
			13: Uint64Field("RxMulticastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 13),
			14: Uint64Field("TxMulticastBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 14),
		},
		Access:  CreatedByOlt,
