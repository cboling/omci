...
func init() {
	multicastsubscriberconfiginfoBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("MeType", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2: Uint16Field("MulticastOperationsProfilePointer", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3: Uint16Field("MaxSimultaneousGroups", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 3),
			4: Uint32Field("MaxMulticastBandwidth", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 4),
			5: ByteField("BandwidthEnforcement", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 5),
			6: TableField("MulticastServicePackageTable", TableAttributeType, TableInfo{nil, 20}, mapset.NewSetWith(Read, Write), false, true, 6),
			7: TableField("AllowedPreviewGroupsTable", TableAttributeType, TableInfo{nil, 22}, mapset.NewSetWith(Read, Write), false, false, 7),
		},
		Access:  CreatedByOlt,
