...
func init() {
	generalpurposebufferBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: Uint32Field("MaximumSize", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, 1),
			2: TableField("BufferTable", TableInfo{nil, 0}, mapset.NewSetWith(Read), true, false, 2),
		},
	}
}
