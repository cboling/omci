...
func init() {
	pseudowireperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("ReceivedPackets", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4:  Uint32Field("TransmittedPackets", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5:  Uint32Field("MissingPackets", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint32Field("MisorderedPackets,Usable", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("MisorderedPacketsDropped", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint32Field("PlayoutBufferUnderrunsOverruns", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint32Field("MalformedPackets", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("StrayPackets", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint32Field("RemotePacketLoss", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
			12: Uint32Field("TdmLBitPacketsTransmitted", 0, mapset.NewSetWith(Read), false, true, false, false, 12),
			13: Uint32Field("Es", 0, mapset.NewSetWith(Read), false, true, false, false, 13),
			14: Uint32Field("Ses", 0, mapset.NewSetWith(Read), false, true, false, false, 14),
			15: Uint32Field("Uas", 0, mapset.NewSetWith(Read), false, true, false, false, 15),
		},
