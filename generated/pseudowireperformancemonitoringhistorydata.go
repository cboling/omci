...
func init() {
	pseudowireperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("ReceivedPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4:  Uint32Field("TransmittedPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  Uint32Field("MissingPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  Uint32Field("MisorderedPackets,Usable", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint32Field("MisorderedPacketsDropped", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  Uint32Field("PlayoutBufferUnderrunsOverruns", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
			9:  Uint32Field("MalformedPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint32Field("StrayPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: Uint32Field("RemotePacketLoss", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 11),
			12: Uint32Field("TdmLBitPacketsTransmitted", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 12),
			13: Uint32Field("Es", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 13),
			14: Uint32Field("Ses", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 14),
			15: Uint32Field("Uas", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 15),
		},
		Access:  CreatedByOlt,
