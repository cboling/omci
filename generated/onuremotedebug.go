...
//
//		Command Format
//			Command format: This attribute defines the format of the command and reply attributes. The value
//			0 defines ASCII string format, while 1 specifies free format. (R) (mandatory) (1-byte)
//
//		Command
//			Command:	This attribute is used to send a command to the ONU. The format of the command is
//			defined by the command format. If the format is ASCII string, the command should be null
//			terminated unless the string is exactly 25-bytes long. The action of setting this attribute
//			should trigger the ONU to discard any previous command reply information and execute the current
//			debugging command. (W) (mandatory) (25-bytes)
//
//		Reply Table
//			Reply table:	This attribute is used to pass reply information back to the OLT. Its format is
//			defined by the command format attribute. The get, get next action sequence must be used with
//			this attribute, since its size is unspecified. (R) (mandatory) (N bytes)
//
