...
func init() {
	geminterworkingterminationpointBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			4: Uint16Field("InterworkingTerminationPointPointer", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 4),
			5: ByteField("PptpCounter", 0, mapset.NewSetWith(Read), false, false, true, 5),
			6: ByteField("OperationalState", 0, mapset.NewSetWith(Read), true, false, true, 6),
			7: Uint16Field("GalProfilePointer", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 7),
			8: ByteField("GalLoopbackConfiguration", 0, mapset.NewSetWith(Read, Write), false, false, false, 8),
		},
	}
}
