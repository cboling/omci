...
func init() {
	geminterworkingterminationpointBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			4: Uint16Field("InterworkingTerminationPointPointer", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 4),
			5: ByteField("PptpCounter", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 5),
			...
			8: ByteField("GalLoopbackConfiguration", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 8),
		},
		Access:  CreatedByOlt,
