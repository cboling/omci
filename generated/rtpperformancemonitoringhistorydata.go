...
func init() {
	rtpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("RtpErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint32Field("PacketLoss", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: Uint32Field("MaximumJitter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6: Uint32Field("MaximumTimeBetweenRealTimeTransportControlProtocolRtcpPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7: Uint32Field("BufferUnderflows", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8: Uint32Field("BufferOverflows", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
		},
		Access:  CreatedByOlt,
