...
func init() {
	rtpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("RtpErrors", 0, Read, false, false, false, 3),
			4: Uint32Field("PacketLoss", 0, Read, false, false, false, 4),
			5: Uint32Field("MaximumJitter", 0, Read, false, false, false, 5),
			6: Uint32Field("MaximumTimeBetweenRealTimeTransportControlProtocolRtcpPackets", 0, Read, false, false, false, 6),
			7: Uint32Field("BufferUnderflows", 0, Read, false, false, false, 7),
			8: Uint32Field("BufferOverflows", 0, Read, false, false, false, 8),
		},
	}
}
