...
func init() {
	multicastsubscribermonitorBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2: Uint32Field("CurrentMulticastBandwidth", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 2),
			3: Uint32Field("JoinMessagesCounter", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 3),
			4: Uint32Field("BandwidthExceededCounter", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 4),
			5: TableField("Ipv4ActiveGroupListTable", TableAttributeType, TableInfo{nil, 24}, mapset.NewSetWith(Read), false, false, 5),
			6: TableField("Ipv6ActiveGroupListTable", TableAttributeType, TableInfo{nil, 58}, mapset.NewSetWith(Read), false, true, 6),
		},
		Access:  CreatedByOlt,
