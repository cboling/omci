...
func init() {
	xdsllineinventoryandstatusdatapart1BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  Uint64Field("XtuCG9941VendorId", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 1),
			2:  Uint64Field("XtuRG9941VendorId", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 2),
			3:  Uint64Field("XtuCSystemVendorId", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  Uint64Field("XtuRSystemVendorId", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  MultiByteField("XtuCVersionNumber", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, 5),
			6:  MultiByteField("XtuRVersionNumber", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, 6),
			7:  MultiByteField("XtuCSerialNumberPart1", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, 7),
			8:  MultiByteField("XtuCSerialNumberPart2", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, 8),
			9:  MultiByteField("XtuRSerialNumberPart1", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, 9),
			10: MultiByteField("XtuRSerialNumberPart2", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, 10),
			11: Uint32Field("XtuCSelfTestResults", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 11),
			12: Uint32Field("XtuRSelfTestResults", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 12),
			13: MultiByteField("XtuCTransmissionSystemCapability", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, false, 13),
			14: MultiByteField("XtuRTransmissionSystemCapability", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, false, 14),
			15: ByteField("InitializationSuccessFailureCause", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 15),
		},
		Access:  CreatedByOnu,
