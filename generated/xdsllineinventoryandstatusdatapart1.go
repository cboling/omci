...
func NewXdslLineInventoryAndStatusDataPart1(params ...ParamData) (IManagedEntityDefinition, error) {
	...
	entity := BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5: MultiByteField("XtuCVersionNumber", 16, nil, Read),
			6: MultiByteField("XtuRVersionNumber", 16, nil, Read),
			7: MultiByteField("XtuCSerialNumberPart1", 16, nil, Read),
			8: MultiByteField("XtuCSerialNumberPart2", 16, nil, Read),
			9: MultiByteField("XtuRSerialNumberPart1", 16, nil, Read),
			10: MultiByteField("XtuRSerialNumberPart2", 16, nil, Read),
			11: Uint32Field("XtuCSelfTestResults", 0, Read),
			12: Uint32Field("XtuRSelfTestResults", 0, Read),
			13: MultiByteField("XtuCTransmissionSystemCapability", 7, nil, Read),
			14: MultiByteField("XtuRTransmissionSystemCapability", 7, nil, Read),
