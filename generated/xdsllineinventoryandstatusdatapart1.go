...
func init() {
	xdsllineinventoryandstatusdatapart1BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  MultiByteField("XtuCVersionNumber", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, false, 5),
			6:  MultiByteField("XtuRVersionNumber", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, false, 6),
			7:  MultiByteField("XtuCSerialNumberPart1", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, false, 7),
			8:  MultiByteField("XtuCSerialNumberPart2", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, false, 8),
			9:  MultiByteField("XtuRSerialNumberPart1", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, false, 9),
			10: MultiByteField("XtuRSerialNumberPart2", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, false, 10),
			...
			13: MultiByteField("XtuCTransmissionSystemCapability", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, false, false, 13),
			14: MultiByteField("XtuRTransmissionSystemCapability", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, false, false, 14),
