...
func init() {
	ethernetflowterminationpointBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("DestinationMac", OctetsAttributeType, 6, toOctets("AAAAAAAA"), mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 1),
			2: MultiByteField("SourceMac", OctetsAttributeType, 6, toOctets("AAAAAAAA"), mapset.NewSetWith(Read), false, false, false, 2),
			3: ByteField("TagPolicy", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 3),
			4: Uint16Field("Tci", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 4),
			5: ByteField("Loopback", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 5),
		},
		Access:  CreatedByOlt,
