...
func init() {
	ethernetflowterminationpointBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("DestinationMac", OctetsAttributeType, 6, nil, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 1),
			2: MultiByteField("SourceMac", OctetsAttributeType, 6, nil, mapset.NewSetWith(Read), false, false, false, 2),
