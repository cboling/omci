...
func init() {
	ethernetflowterminationpointBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("DestinationMac", OctetsAttributeType, 6, nil, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2: MultiByteField("SourceMac", OctetsAttributeType, 6, nil, mapset.NewSetWith(Read), false, false, 2),
			3: ByteField("TagPolicy", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 3),
			4: Uint16Field("Tci", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 4),
			5: ByteField("Loopback", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
		},
		Access:  CreatedByOlt,
