...
func init() {
	voipmediaprofileBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("FaxMode", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2:  Uint16Field("VoiceServiceProfilePointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3:  ByteField("CodecSelection1StOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 3),
			4:  ByteField("PacketPeriodSelection1StOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5:  ByteField("SilenceSuppression1StOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 5),
			6:  ByteField("CodecSelection2NdOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 6),
			7:  ByteField("PacketPeriodSelection2NdOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 7),
			8:  ByteField("SilenceSuppression2NdOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 8),
			9:  ByteField("CodecSelection3RdOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 9),
			10: ByteField("PacketPeriodSelection3RdOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 10),
			11: ByteField("SilenceSuppression3RdOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 11),
			12: ByteField("CodecSelection4ThOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 12),
			13: ByteField("PacketPeriodSelection4ThOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 13),
			14: ByteField("SilenceSuppression4ThOrder", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 14),
			15: ByteField("OobDtmf", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 15),
			16: Uint16Field("RtpProfilePointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 16),
		},
		Access:  CreatedByOlt,
