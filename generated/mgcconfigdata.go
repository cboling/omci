...
func init() {
	mgcconfigdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  Uint16Field("PrimaryMgc", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2:  Uint16Field("SecondaryMgc", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3:  Uint16Field("TcpUdpPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 3),
			4:  ByteField("Version", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5:  ByteField("MessageFormat", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 5),
			6:  Uint16Field("MaximumRetryTime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 6),
			7:  Uint16Field("MaximumRetryAttempts", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 7),
			8:  Uint16Field("ServiceChangeDelay", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 8),
			9:  MultiByteField("TerminationIdBase", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, true, 9),
			10: Uint32Field("Softswitch", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 10),
			11: Uint16Field("MessageIdPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 11),
		},
		Access:  CreatedByOlt,
