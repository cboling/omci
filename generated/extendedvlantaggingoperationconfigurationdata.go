...
func init() {
	extendedvlantaggingoperationconfigurationdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("AssociationType", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 1),
			2: Uint16Field("ReceivedFrameVlanTaggingOperationTableMaxSize", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 2),
			3: Uint16Field("InputTpid", UnsignedIntegerAttributeType, 34984, mapset.NewSetWith(Read, Write), false, false, false, 3),
			4: Uint16Field("OutputTpid", UnsignedIntegerAttributeType, 34984, mapset.NewSetWith(Read, Write), false, false, false, 4),
			5: ByteField("DownstreamMode", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 5),
			6: TableField("ReceivedFrameVlanTaggingOperationTable", TableAttributeType, TableInfo{nil, 16}, mapset.NewSetWith(Read, Write), false, false, false, 6),
			7: Uint16Field("AssociatedMePointer", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 7),
			8: MultiByteField("DscpToPBitMapping", OctetsAttributeType, 24, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), mapset.NewSetWith(Read, Write), false, true, false, 8),
		},
		Access:  CreatedByOlt,
