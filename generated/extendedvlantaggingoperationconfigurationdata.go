...
func init() {
	extendedvlantaggingoperationconfigurationdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint16Field("InputTpid", 34984, mapset.NewSetWith(Read, Write), false, false, false, false, 3),
			4: Uint16Field("OutputTpid", 34984, mapset.NewSetWith(Read, Write), false, false, false, false, 4),
			...
			8: MultiByteField("DscpToPBitMapping", 24, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), mapset.NewSetWith(Read, Write), false, false, true, false, 8),
		},
		Access:  CreatedByOlt,
