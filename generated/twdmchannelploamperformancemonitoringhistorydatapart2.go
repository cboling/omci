...
func init() {
	twdmchannelploamperformancemonitoringhistorydatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("SystemProfileMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  Uint32Field("ChannelProfileMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  Uint32Field("BurstProfileMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint32Field("AssignOnuIdMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint32Field("UnsatisfiedAdjustTxWavelengthRequests", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint32Field("DeactivateOnuIdMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint32Field("DisableSerialNumberMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint32Field("RequestRegistrationMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
			11: Uint32Field("AssignAllocIdMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 11),
			12: Uint32Field("KeyControlMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 12),
			13: Uint32Field("SleepAllowMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 13),
			14: Uint32Field("TuningControlRequestMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 14),
			15: Uint32Field("TuningControlCompleteDMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 15),
			16: Uint32Field("CalibrationRequestMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 16),
		},
		Access:  CreatedByOlt,
