...
func init() {
	twdmchannelploamperformancemonitoringhistorydatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("SystemProfileMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4:  Uint32Field("ChannelProfileMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5:  Uint32Field("BurstProfileMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint32Field("AssignOnuIdMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("UnsatisfiedAdjustTxWavelengthRequests", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint32Field("DeactivateOnuIdMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint32Field("DisableSerialNumberMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("RequestRegistrationMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint32Field("AssignAllocIdMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
			12: Uint32Field("KeyControlMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 12),
			13: Uint32Field("SleepAllowMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 13),
			14: Uint32Field("TuningControlRequestMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 14),
