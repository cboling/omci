...
func init() {
	physicalpathterminationpointethernetuniBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("ExpectedType", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			2:  ByteField("SensedType", EnumerationAttributeType, 0, mapset.NewSetWith(Read), true, false, 2),
			3:  ByteField("AutoDetectionConfiguration", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4:  ByteField("EthernetLoopbackConfiguration", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 4),
			5:  ByteField("AdministrativeState", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
			6:  ByteField("OperationalState", EnumerationAttributeType, 0, mapset.NewSetWith(Read), true, true, 6),
			7:  ByteField("ConfigurationInd", EnumerationAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint16Field("MaxFrameSize", UnsignedIntegerAttributeType, 1518, mapset.NewSetWith(Read, Write), false, false, 8),
			9:  ByteField("DteOrDceInd", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 9),
			10: Uint16Field("PauseTime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 10),
			11: ByteField("BridgedOrIpInd", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 11),
			12: ByteField("Arc", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), true, true, 12),
			13: ByteField("ArcInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 13),
			14: ByteField("PppoeFilter", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 14),
			15: ByteField("PowerControl", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 15),
		},
		Access:  CreatedByOnu,
