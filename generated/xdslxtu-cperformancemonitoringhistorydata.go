...
func init() {
	xdslxtucperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint16Field("LossOfFrameSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4:  Uint16Field("LossOfSignalSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5:  Uint16Field("LossOfLinkSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint16Field("LossOfPowerSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint16Field("ErroredSecondsEs", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint16Field("SeverelyErroredSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint16Field("LineInitializations", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint16Field("FailedLineInitializations", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint16Field("ShortInitializations", 0, mapset.NewSetWith(Read), false, true, true, false, 11),
			12: Uint16Field("FailedShortInitializations", 0, mapset.NewSetWith(Read), false, true, true, false, 12),
			13: Uint16Field("FecSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 13),
			14: Uint16Field("UnavailableSeconds", 0, mapset.NewSetWith(Read), false, true, false, false, 14),
