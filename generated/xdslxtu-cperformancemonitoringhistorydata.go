...
func init() {
	xdslxtucperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint16Field("LossOfFrameSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  Uint16Field("LossOfSignalSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  Uint16Field("LossOfLinkSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint16Field("LossOfPowerSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint16Field("ErroredSecondsEs", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint16Field("SeverelyErroredSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint16Field("LineInitializations", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint16Field("FailedLineInitializations", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
			11: Uint16Field("ShortInitializations", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 11),
			12: Uint16Field("FailedShortInitializations", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 12),
			13: Uint16Field("FecSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 13),
			14: Uint16Field("UnavailableSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 14),
			15: Uint16Field("SosSuccessCount,NearEnd", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 15),
			16: Uint16Field("SosSuccessCount,FarEnd", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 16),
		},
		Access:  CreatedByOlt,
