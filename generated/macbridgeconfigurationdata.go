...
func init() {
	macbridgeconfigurationdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("BridgeMacAddress", OctetsAttributeType, 6, toOctets("AAAAAAAA"), mapset.NewSetWith(Read), false, false, false, 1),
			2: Uint16Field("BridgePriority", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 2),
			3: MultiByteField("DesignatedRoot", OctetsAttributeType, 8, toOctets("AAAAAAAAAAA="), mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint32Field("RootPathCost", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: ByteField("BridgePortCount", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6: Uint16Field("RootPortNum", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7: Uint16Field("HelloTime", UnsignedIntegerAttributeType, 256, mapset.NewSetWith(Read), false, true, false, 7),
			8: Uint16Field("ForwardDelay", UnsignedIntegerAttributeType, 1024, mapset.NewSetWith(Read), false, true, false, 8),
		},
		Access:  CreatedByOnu,
