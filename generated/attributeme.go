...
func init() {
	attributemeBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("Name", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read), false, false, 1),
			2: Uint16Field("Size", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 2),
			3: ByteField("Access", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: ByteField("Format", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint32Field("LowerLimit", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6: Uint32Field("UpperLimit", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7: Uint32Field("BitField", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8: TableField("CodePointsTable", TableAttributeType, TableInfo{nil, 2}, mapset.NewSetWith(Read), false, false, 8),
			9: ByteField("Support", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
		},
		Access:  CreatedByOnu,
