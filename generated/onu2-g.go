...
func init() {
	onu2gBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  MultiByteField("EquipmentId", StringAttributeType, 20, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAA="), mapset.NewSetWith(Read), false, true, 1),
			2:  ByteField("OpticalNetworkUnitManagementAndControlChannelOmccVersion", EnumerationAttributeType, 164, mapset.NewSetWith(Read), true, false, 2),
			3:  Uint16Field("VendorProductCode", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 3),
			4:  ByteField("SecurityCapability", EnumerationAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  ByteField("SecurityMode", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
			6:  Uint16Field("TotalPriorityQueueNumber", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  ByteField("TotalTrafficSchedulerNumber", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  ByteField("Deprecated", UnsignedIntegerAttributeType, 1, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint16Field("TotalGemPortIdNumber", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 9),
			10: Uint32Field("Sysuptime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 10),
			11: Uint16Field("ConnectivityCapability", BitFieldAttributeType, 0, mapset.NewSetWith(Read), false, true, 11),
			12: ByteField("CurrentConnectivityMode", BitFieldAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 12),
			13: Uint16Field("QualityOfServiceQosConfigurationFlexibility", BitFieldAttributeType, 0, mapset.NewSetWith(Read), false, true, 13),
			14: Uint16Field("PriorityQueueScaleFactor", UnsignedIntegerAttributeType, 1, mapset.NewSetWith(Read, Write), false, true, 14),
		},
		Access:  CreatedByOnu,
