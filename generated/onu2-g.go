...
func init() {
	onu2gBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  MultiByteField("EquipmentId", 20, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAA="), mapset.NewSetWith(Read), false, false, true, false, 1),
			2:  ByteField("OpticalNetworkUnitManagementAndControlChannelOmccVersion", 164, mapset.NewSetWith(Read), true, false, false, false, 2),
			...
			8:  ByteField("Deprecated", 1, mapset.NewSetWith(Read), false, false, false, true, 8),
			...
			14: Uint16Field("PriorityQueueScaleFactor", 1, mapset.NewSetWith(Read, Write), false, false, true, false, 14),
		},
		Access:  CreatedByOnu,
