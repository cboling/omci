...
func init() {
	physicalpathterminationpointxdslunipart1BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("LoopbackConfiguration", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			...
			4:  Uint16Field("XdslLineConfigurationProfile", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 4),
			5:  Uint16Field("XdslSubcarrierMaskingDownstreamProfile", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
			6:  Uint16Field("XdslSubcarrierMaskingUpstreamProfile", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 6),
			7:  Uint16Field("XdslDownstreamPowerSpectralDensityPsdMaskProfile", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 7),
			8:  Uint16Field("XdslDownstreamRfiBandsProfile", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 8),
			9:  ByteField("Arc", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), true, true, 9),
			10: ByteField("ArcInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 10),
			11: ByteField("ModemType", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 11),
			12: Uint16Field("UpstreamPsdMaskProfile", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 12),
			13: Uint16Field("NetworkSpecificExtensionsPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 13),
		},
		Access:  CreatedByOnu,
