...
func init() {
	vlantaggingfilterdataBME = &BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("VlanFilterList", 24, nil, Read|SetByCreate|Write, false, false, false),
			2: ByteField("ForwardOperation", 0, Read|SetByCreate|Write, false, false, false),
			3: ByteField("NumberOfEntries", 0, Read|SetByCreate|Write, false, false, false),
		},
	}
}
...
func NewVlanTaggingFilterData(params ...ParamData) (*ManagedEntity, error) {
	entity := &ManagedEntity{
		Definition: vlantaggingfilterdataBME,
