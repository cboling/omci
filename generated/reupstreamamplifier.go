...
func init() {
	reupstreamamplifierBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  ByteField("OperationalMode", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4:  ByteField("Arc", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), true, true, 4),
			5:  ByteField("ArcInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 5),
			6:  Uint16Field("ReDownstreamAmplifierPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 6),
			7:  TableField("TotalOpticalReceiveSignalLevelTable", TableAttributeType, TableInfo{nil, 4}, mapset.NewSetWith(Read), false, true, 7),
			8:  TableField("PerBurstReceiveSignalLevelTable", TableAttributeType, TableInfo{nil, 4}, mapset.NewSetWith(Read), false, true, 8),
			9:  ByteField("LowerReceiveOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 9),
			10: ByteField("UpperReceiveOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 10),
			11: Uint16Field("TransmitOpticalSignalLevel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 11),
			12: ByteField("LowerTransmitOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 12),
			13: ByteField("UpperTransmitOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 13),
		},
		Access:  CreatedByOnu,
