...
func init() {
	dot1agmaintenanceassociationBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: MultiByteField("ShortMaName1,ShortMaName2", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, false, 3),
			...
			5: MultiByteField("AssociatedVlans", OctetsAttributeType, 24, nil, mapset.NewSetWith(Read, Write), false, false, false, 5),
