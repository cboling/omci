...
func NewIpHostConfigData(params ...ParamData) (IManagedEntityDefinition, error) {
	...
	entity := BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			9:  Uint32Field("CurrentAddress", 0, Read, false, false, false, true),
			10: Uint32Field("CurrentMask", 0, Read, false, false, false, true),
			11: Uint32Field("CurrentGateway", 0, Read, false, false, false, true),
			12: Uint32Field("CurrentPrimaryDns", 0, Read, false, false, false, true),
			13: Uint32Field("CurrentSecondaryDns", 0, Read, false, false, false, true),
			14: MultiByteField("DomainName", 25, nil, Read, false, false, false, false),
			15: MultiByteField("HostName", 25, nil, Read, false, false, false, false),
			16: Uint16Field("RelayAgentOptions", 0, Read|Write, false, false, false, true),
		},
	}
