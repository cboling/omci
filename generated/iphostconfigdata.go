...
func init() {
	iphostconfigdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2:  MultiByteField("MacAddress", OctetsAttributeType, 6, nil, mapset.NewSetWith(Read), false, false, false, 2),
			3:  MultiByteField("OnuIdentifier", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, false, 3),
			...
			14: MultiByteField("DomainName", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read), true, false, false, 14),
			15: MultiByteField("HostName", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read), true, false, false, 15),
