...
func init() {
	sipagentperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("Transactions", 0, mapset.NewSetWith(Read), false, true, true, false, 3),
			4:  Uint32Field("RxInviteReqs", 0, mapset.NewSetWith(Read), false, true, true, false, 4),
			5:  Uint32Field("RxInviteRetrans", 0, mapset.NewSetWith(Read), false, true, true, false, 5),
			6:  Uint32Field("RxNoninviteReqs", 0, mapset.NewSetWith(Read), false, true, true, false, 6),
			7:  Uint32Field("RxNoninviteRetrans", 0, mapset.NewSetWith(Read), false, true, true, false, 7),
			8:  Uint32Field("RxResponse", 0, mapset.NewSetWith(Read), false, true, true, false, 8),
			9:  Uint32Field("RxResponseRetransmissions", 0, mapset.NewSetWith(Read), false, true, true, false, 9),
			10: Uint32Field("TxInviteReqs", 0, mapset.NewSetWith(Read), false, true, true, false, 10),
			11: Uint32Field("TxInviteRetrans", 0, mapset.NewSetWith(Read), false, true, true, false, 11),
			12: Uint32Field("TxNoninviteReqs", 0, mapset.NewSetWith(Read), false, true, true, false, 12),
			13: Uint32Field("TxNoninviteRetrans", 0, mapset.NewSetWith(Read), false, true, true, false, 13),
			14: Uint32Field("TxResponse", 0, mapset.NewSetWith(Read), false, true, true, false, 14),
			15: Uint32Field("TxResponseRetransmissions", 0, mapset.NewSetWith(Read), false, true, true, false, 15),
		},
