...
func init() {
	sipagentperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("Transactions", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 3),
			4:  Uint32Field("RxInviteReqs", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 4),
			5:  Uint32Field("RxInviteRetrans", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 5),
			6:  Uint32Field("RxNoninviteReqs", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 6),
			7:  Uint32Field("RxNoninviteRetrans", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 7),
			8:  Uint32Field("RxResponse", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 8),
			9:  Uint32Field("RxResponseRetransmissions", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 9),
			10: Uint32Field("TxInviteReqs", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 10),
			11: Uint32Field("TxInviteRetrans", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 11),
			12: Uint32Field("TxNoninviteReqs", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 12),
			13: Uint32Field("TxNoninviteRetrans", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 13),
			14: Uint32Field("TxResponse", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 14),
			15: Uint32Field("TxResponseRetransmissions", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 15),
		},
		Access:  CreatedByOlt,
