...
func init() {
	sipagentperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("Transactions", 0, Read, false, false, true, 3),
			4:  Uint32Field("RxInviteReqs", 0, Read, false, false, true, 4),
			5:  Uint32Field("RxInviteRetrans", 0, Read, false, false, true, 5),
			6:  Uint32Field("RxNoninviteReqs", 0, Read, false, false, true, 6),
			7:  Uint32Field("RxNoninviteRetrans", 0, Read, false, false, true, 7),
			8:  Uint32Field("RxResponse", 0, Read, false, false, true, 8),
			9:  Uint32Field("RxResponseRetransmissions", 0, Read, false, false, true, 9),
			10: Uint32Field("TxInviteReqs", 0, Read, false, false, true, 10),
			11: Uint32Field("TxInviteRetrans", 0, Read, false, false, true, 11),
			12: Uint32Field("TxNoninviteReqs", 0, Read, false, false, true, 12),
			13: Uint32Field("TxNoninviteRetrans", 0, Read, false, false, true, 13),
			14: Uint32Field("TxResponse", 0, Read, false, false, true, 14),
			15: Uint32Field("TxResponseRetransmissions", 0, Read, false, false, true, 15),
		},
	}
}
