...
func init() {
	rtpprofiledataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: Uint16Field("LocalPortMin", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2: Uint16Field("LocalPortMax", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 2),
			3: ByteField("DscpMark", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 3),
			4: ByteField("PiggybackEvents", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5: ByteField("ToneEvents", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 5),
			6: ByteField("DtmfEvents", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 6),
			7: ByteField("CasEvents", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 7),
			8: Uint16Field("IpHostConfigPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 8),
		},
		Access:  CreatedByOlt,
