...
func init() {
	xdslchannelupstreamstatusdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  ByteField("ImpulseNoiseProtectionReportingMode", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  ByteField("ActualSizeOfReedSolomonCodeword", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  ByteField("ActualNumberOfReedSolomonRedundancyBytes", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint16Field("ActualNumberOfBitsPerSymbol", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint16Field("ActualInterleavingDepth", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: ByteField("ActualInterleavingBlockLength", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
			11: ByteField("ActualLatencyPath", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 11),
		},
		Access:  CreatedByOnu,
