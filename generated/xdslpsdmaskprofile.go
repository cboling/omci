...
func init() {
	xdslpsdmaskprofileBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: TableField("PsdMaskTable", TableAttributeType, TableInfo{nil, 4}, mapset.NewSetWith(Read, Write), false, false, 1),
			2: ByteField("MaskValid", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
		},
		Access:  CreatedByOlt,
