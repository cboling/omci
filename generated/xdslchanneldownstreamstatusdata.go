...
func init() {
	xdslchanneldownstreamstatusdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("ActualInterleavingDelay", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 1),
			2:  Uint32Field("ActualDataRate", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 2),
			3:  Uint32Field("PreviousDataRate", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  ByteField("ActualImpulseNoiseProtection", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  ByteField("ActualSizeOfReedSolomonCodeword", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  ByteField("ActualNumberOfReedSolomonRedundancyBytes", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint16Field("ActualNumberOfBitsPerSymbol", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint16Field("ActualInterleavingDepth", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  ByteField("ActualInterleavingBlockLength", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: ByteField("ActualLatencyPath", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
			11: ByteField("ActualImpulseNoiseProtectionAgainstREpetitiveELectricalIMpulseNOiseActinpRein", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 11),
		},
		Access:  CreatedByOnu,
