...
func init() {
	sipagentconfigdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  Uint16Field("ProxyServerAddressPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2:  Uint16Field("OutboundProxyAddressPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3:  Uint32Field("PrimarySipDns", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 3),
			4:  Uint32Field("SecondarySipDns", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5:  Uint16Field("TcpUdpPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
			6:  Uint32Field("SipRegExpTime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 6),
			7:  Uint32Field("SipReregHeadStartTime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 7),
			8:  Uint16Field("HostPartUri", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 8),
			9:  ByteField("SipStatus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), true, false, 9),
			10: Uint16Field("SipRegistrar", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 10),
			11: Uint32Field("Softswitch", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 11),
			12: MultiByteField("SipResponseTable", OctetsAttributeType, 5, nil, mapset.NewSetWith(Read, Write), false, true, 12),
			13: ByteField("SipOptionTransmitControl", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 13),
			14: ByteField("SipUriFormat", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 14),
			15: Uint16Field("RedundantSipAgentPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 15),
		},
		Access:  CreatedByOlt,
