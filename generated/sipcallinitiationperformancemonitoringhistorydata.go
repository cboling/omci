...
var sipcallinitiationperformancemonitoringhistorydataBME *BaseManagedEntityDefinition
...
func init() {
	sipcallinitiationperformancemonitoringhistorydataBME = &BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("FailedToConnectCounter", 0, Read, false, false, false),
			4: Uint32Field("FailedToValidateCounter", 0, Read, false, false, false),
			5: Uint32Field("TimeoutCounter", 0, Read, false, false, false),
			6: Uint32Field("FailureReceivedCounter", 0, Read, false, false, false),
			7: Uint32Field("FailedToAuthenticateCounter", 0, Read, false, false, false),
		},
	}
}
