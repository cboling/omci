...
func init() {
	sipcallinitiationperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("FailedToConnectCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint32Field("FailedToValidateCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint32Field("TimeoutCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6: Uint32Field("FailureReceivedCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7: Uint32Field("FailedToAuthenticateCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
		},
		Access:  CreatedByOlt,
