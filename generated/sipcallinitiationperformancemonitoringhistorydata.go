...
func init() {
	sipcallinitiationperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("FailedToConnectCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint32Field("FailedToValidateCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5: Uint32Field("TimeoutCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6: Uint32Field("FailureReceivedCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7: Uint32Field("FailedToAuthenticateCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
		},
