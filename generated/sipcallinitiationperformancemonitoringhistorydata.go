...
func NewSipCallInitiationPerformanceMonitoringHistoryData(params ...ParamData) (IManagedEntity, error) {
	...
	entity := BaseManagedEntity{
		...
		attributeList: []omci.IAttribute{
			...
			omci.NewUint32Field("FailedToConnectCounter", 0, omci.Read),
			omci.NewUint32Field("FailedToValidateCounter", 0, omci.Read),
			omci.NewUint32Field("TimeoutCounter", 0, omci.Read),
			omci.NewUint32Field("FailureReceivedCounter", 0, omci.Read),
