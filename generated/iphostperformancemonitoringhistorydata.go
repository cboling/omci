...
func init() {
	iphostperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("IcmpErrors", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint32Field("DnsErrors", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5: Uint16Field("DhcpTimeouts", 0, mapset.NewSetWith(Read), false, true, true, false, 5),
			6: Uint16Field("IpAddressConflict", 0, mapset.NewSetWith(Read), false, true, true, false, 6),
