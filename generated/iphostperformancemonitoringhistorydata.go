...
func init() {
	iphostperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("IcmpErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint32Field("DnsErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint16Field("DhcpTimeouts", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 5),
			6: Uint16Field("IpAddressConflict", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 6),
			7: Uint16Field("OutOfMemory", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 7),
			8: Uint16Field("InternalError", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 8),
		},
		Access:  CreatedByOlt,
