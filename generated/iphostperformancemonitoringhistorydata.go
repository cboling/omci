...
func init() {
	iphostperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("IcmpErrors", 0, Read, false, false, false, 3),
			4: Uint32Field("DnsErrors", 0, Read, false, false, false, 4),
			5: Uint16Field("DhcpTimeouts", 0, Read, false, false, true, 5),
			6: Uint16Field("IpAddressConflict", 0, Read, false, false, true, 6),
			7: Uint16Field("OutOfMemory", 0, Read, false, false, true, 7),
			8: Uint16Field("InternalError", 0, Read, false, false, true, 8),
		},
	}
}
