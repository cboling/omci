...
func NewIpHostPerformanceMonitoringHistoryData(params ...ParamData) (IManagedEntityDefinition, error) {
	...
	entity := BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("IcmpErrors", 0, Read, false, false, false, false),
			4: Uint32Field("DnsErrors", 0, Read, false, false, false, false),
			5: Uint16Field("DhcpTimeouts", 0, Read, false, false, false, true),
			6: Uint16Field("IpAddressConflict", 0, Read, false, false, false, true),
			7: Uint16Field("OutOfMemory", 0, Read, false, false, false, true),
			8: Uint16Field("InternalError", 0, Read, false, false, false, true),
		},
	}
