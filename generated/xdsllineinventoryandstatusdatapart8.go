...
func init() {
	xdsllineinventoryandstatusdatapart8BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: MultiByteField("DateTimeStampingOfNearEndTestParametersStampTestNe", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, true, false, 3),
			4: MultiByteField("DateTimeStampingOfFarEndTestParametersStampTestFe", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, true, false, 4),
			5: MultiByteField("DateTimeStampingOfLastSuccessfulDownstreamOlrOperationStampOlrDs", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, true, false, 5),
			6: MultiByteField("DateTimeStampingOfLastSuccessfulUpstreamOlrOperationStampOlrUs", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, true, false, 6),
		},
		Access:  CreatedByOnu,
