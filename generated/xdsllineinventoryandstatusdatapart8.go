...
func init() {
	xdsllineinventoryandstatusdatapart8BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("RetransmissionUsedDownstreamRtxUsedds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 1),
			2: ByteField("RetransmissionUsedUpstreamRtxUsedus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 2),
			3: MultiByteField("DateTimeStampingOfNearEndTestParametersStampTestNe", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, true, 3),
			4: MultiByteField("DateTimeStampingOfFarEndTestParametersStampTestFe", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, true, 4),
			5: MultiByteField("DateTimeStampingOfLastSuccessfulDownstreamOlrOperationStampOlrDs", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, true, 5),
			6: MultiByteField("DateTimeStampingOfLastSuccessfulUpstreamOlrOperationStampOlrUs", OctetsAttributeType, 7, nil, mapset.NewSetWith(Read), false, true, 6),
		},
		Access:  CreatedByOnu,
