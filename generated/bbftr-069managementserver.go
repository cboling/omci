...
func init() {
	bbftr069managementserverBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2: Uint16Field("AcsNetworkAddress", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 2),
			3: Uint16Field("AssociatedTag", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 3),
		},
		Access:  CreatedByOnu,
