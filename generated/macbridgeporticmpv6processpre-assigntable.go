...
func init() {
	macbridgeporticmpv6processpreassigntableBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("Icmpv6ErrorMessagesProcessing", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			2: ByteField("Icmpv6InformationalMessagesProcessing", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
			3: ByteField("RouterSolicitationProcessing", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4: ByteField("RouterAdvertisementProcessing", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 4),
			5: ByteField("NeighbourSolicitationProcessing", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
			6: ByteField("NeighbourAdvertisementProcessing", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 6),
			7: ByteField("RedirectProcessing", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 7),
			8: ByteField("MulticastListenerQueryProcessing", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 8),
			9: ByteField("UnknownIcmpv6Processing", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 9),
		},
		Access:  CreatedByOnu,
