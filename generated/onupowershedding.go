...
func init() {
	onupowersheddingBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  Uint16Field("RestorePowerTimerResetInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			2:  Uint16Field("DataClassSheddingInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
			3:  Uint16Field("VoiceClassSheddingInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4:  Uint16Field("VideoOverlayClassSheddingInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 4),
			5:  Uint16Field("VideoReturnClassSheddingInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
			6:  Uint16Field("DigitalSubscriberLineClassSheddingInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 6),
			7:  Uint16Field("AtmClassSheddingInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 7),
			8:  Uint16Field("CesClassSheddingInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 8),
			9:  Uint16Field("FrameClassSheddingInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 9),
			10: Uint16Field("SdhSonetClassSheddingInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 10),
			11: Uint16Field("SheddingStatus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), true, true, 11),
		},
		Access:  CreatedByOnu,
