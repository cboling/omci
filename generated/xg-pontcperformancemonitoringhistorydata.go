...
func init() {
	xgpontcperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("PsbdHecErrorCount", 0, mapset.NewSetWith(Read), false, true, true, false, 3),
			4:  Uint32Field("XgtcHecErrorCount", 0, mapset.NewSetWith(Read), false, true, true, false, 4),
			5:  Uint32Field("UnknownProfileCount", 0, mapset.NewSetWith(Read), false, true, true, false, 5),
			6:  Uint32Field("TransmittedXgPonEncapsulationMethodXgemFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("FragmentXgemFrames", 0, mapset.NewSetWith(Read), false, true, true, false, 7),
			8:  Uint32Field("XgemHecLostWordsCount", 0, mapset.NewSetWith(Read), false, true, true, false, 8),
			9:  Uint32Field("XgemKeyErrors", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("XgemHecErrorCount", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint64Field("TransmittedBytesInNonIdleXgemFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
			12: Uint64Field("ReceivedBytesInNonIdleXgemFrames", 0, mapset.NewSetWith(Read), false, true, true, false, 12),
			13: Uint32Field("LossOfDownstreamSynchronizationLodsEventCount", 0, mapset.NewSetWith(Read), false, true, true, false, 13),
