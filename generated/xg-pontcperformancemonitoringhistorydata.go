...
func init() {
	xgpontcperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("PsbdHecErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 3),
			4:  Uint32Field("XgtcHecErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 4),
			5:  Uint32Field("UnknownProfileCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 5),
			6:  Uint32Field("TransmittedXgPonEncapsulationMethodXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint32Field("FragmentXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 7),
			8:  Uint32Field("XgemHecLostWordsCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 8),
			9:  Uint32Field("XgemKeyErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint32Field("XgemHecErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: Uint64Field("TransmittedBytesInNonIdleXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 11),
			12: Uint64Field("ReceivedBytesInNonIdleXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 12),
			13: Uint32Field("LossOfDownstreamSynchronizationLodsEventCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 13),
			14: Uint32Field("LodsEventRestoredCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 14),
			15: Uint32Field("OnuReactivationByLodsEvents", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 15),
		},
		Access:  CreatedByOlt,
