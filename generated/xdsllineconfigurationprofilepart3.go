...
func init() {
	xdsllineconfigurationprofilepart3BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("LoopDiagnosticsModeForcedLdsf", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2:  ByteField("AutomodeColdStartForced", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3:  ByteField("L2Atpr", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 3),
			4:  ByteField("L2Atprt", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5:  ByteField("ForceInpDownstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
			6:  ByteField("ForceInpUpstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 6),
			7:  ByteField("UpdateRequestFlagForNearEndTestParameters", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), true, true, 7),
			8:  ByteField("UpdateRequestFlagForFarEndTestParameters", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), true, true, 8),
			9:  Uint16Field("InmInterArrivalTimeOffsetUpstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 9),
			10: ByteField("InmInterArrivalTimeStepUpstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 10),
			11: ByteField("InmClusterContinuationValueUpstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 11),
			12: ByteField("InmEquivalentInpModeUpstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 12),
			13: Uint16Field("InmInterArrivalTimeOffsetDownstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 13),
			14: ByteField("InmInterArrivalTimeStepDownstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 14),
			15: ByteField("InmClusterContinuationValueDownstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 15),
			16: ByteField("InmEquivalentInpModeDownstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 16),
		},
		Access:  CreatedByOlt,
