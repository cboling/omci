...
func NewXdslLineConfigurationProfilePart3(params ...ParamData) (IManagedEntityDefinition, error) {
	...
	entity := BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			7:  ByteField("UpdateRequestFlagForNearEndTestParameters", 0, Read|Write, false, false, false, true),
			8:  ByteField("UpdateRequestFlagForFarEndTestParameters", 0, Read|Write, false, false, false, true),
