...
func init() {
	xgpondownstreammanagementperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("PloamMessageIntegrityCheckMicErrorCount", 0, mapset.NewSetWith(Read), false, true, true, false, 3),
			4:  Uint32Field("DownstreamPloamMessagesCount", 0, mapset.NewSetWith(Read), false, true, true, false, 4),
			5:  Uint32Field("ProfileMessagesReceived", 0, mapset.NewSetWith(Read), false, true, true, false, 5),
			6:  Uint32Field("RangingTimeMessagesReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("DeactivateOnuIdMessagesReceived", 0, mapset.NewSetWith(Read), false, true, true, false, 7),
			8:  Uint32Field("DisableSerialNumberMessagesReceived", 0, mapset.NewSetWith(Read), false, true, true, false, 8),
			9:  Uint32Field("RequestRegistrationMessagesReceived", 0, mapset.NewSetWith(Read), false, true, true, false, 9),
			10: Uint32Field("AssignAllocIdMessagesReceived", 0, mapset.NewSetWith(Read), false, true, true, false, 10),
			11: Uint32Field("KeyControlMessagesReceived", 0, mapset.NewSetWith(Read), false, true, true, false, 11),
			12: Uint32Field("SleepAllowMessagesReceived", 0, mapset.NewSetWith(Read), false, true, true, false, 12),
			13: Uint32Field("BaselineOmciMessagesReceivedCount", 0, mapset.NewSetWith(Read), false, true, true, false, 13),
			14: Uint32Field("ExtendedOmciMessagesReceivedCount", 0, mapset.NewSetWith(Read), false, true, true, false, 14),
