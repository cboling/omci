...
func init() {
	xgpondownstreammanagementperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2:  Uint16Field("ThresholdData12Id", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 2),
			3:  Uint32Field("PloamMessageIntegrityCheckMicErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 3),
			4:  Uint32Field("DownstreamPloamMessagesCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 4),
			5:  Uint32Field("ProfileMessagesReceived", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 5),
			6:  Uint32Field("RangingTimeMessagesReceived", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint32Field("DeactivateOnuIdMessagesReceived", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 7),
			8:  Uint32Field("DisableSerialNumberMessagesReceived", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 8),
			9:  Uint32Field("RequestRegistrationMessagesReceived", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 9),
			10: Uint32Field("AssignAllocIdMessagesReceived", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 10),
			11: Uint32Field("KeyControlMessagesReceived", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 11),
			12: Uint32Field("SleepAllowMessagesReceived", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 12),
			13: Uint32Field("BaselineOmciMessagesReceivedCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 13),
			14: Uint32Field("ExtendedOmciMessagesReceivedCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 14),
			15: Uint32Field("AssignOnuIdMessagesReceived", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 15),
			16: Uint32Field("OmciMicErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 16),
		},
		Access:  CreatedByOlt,
