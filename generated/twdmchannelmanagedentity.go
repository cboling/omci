...
func init() {
	twdmchannelmanagedentityBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("ActiveChannelIndication", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 1),
			2: ByteField("OperationalChannelIndication", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 2),
			3: ByteField("DownstreamWavelengthChannel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: ByteField("UpstreamWavelengthChannel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
		},
		Access:  CreatedByOnu,
