...
func init() {
	reanigBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  Uint16Field("OpticalSignalLevel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 5),
			6:  ByteField("LowerOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 6),
			7:  ByteField("UpperOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 7),
			8:  Uint16Field("TransmitOpticalLevel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 8),
			9:  ByteField("LowerTransmitPowerThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 9),
			10: ByteField("UpperTransmitPowerThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 10),
			11: ByteField("UsageMode", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 11),
			12: Uint32Field("TargetUpstreamFrequency", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 12),
			13: Uint32Field("TargetDownstreamFrequency", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 13),
			14: ByteField("UpstreamSignalTransmissionMode", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 14),
		},
		Access:  CreatedByOnu,
