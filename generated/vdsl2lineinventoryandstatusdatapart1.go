...
func init() {
	vdsl2lineinventoryandstatusdatapart1BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("Vdsl2TransmissionSystemCapabilityXtuC", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 1),
			2:  ByteField("Vdsl2TransmissionSystem", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 2),
			3:  ByteField("Vdsl2Profile", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4:  Uint64Field("Vdsl2LimitPsdMaskAndBandplan", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  Uint32Field("Vdsl2Us0PsdMask", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  ByteField("Actsnrmodeds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  ByteField("Hlingds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  ByteField("Hloggds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
			9:  ByteField("Qlngds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: ByteField("Snrgds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: TableField("MrefpsddsTable", TableAttributeType, TableInfo{nil, 3}, mapset.NewSetWith(Read), false, false, false, 11),
			12: ByteField("Trellisds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 12),
			13: ByteField("ActualRateAdaptationModeDownstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 13),
			14: ByteField("ActualImpulseNoiseProtectionRobustOperationsChannelRocDownstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 14),
			15: Uint16Field("SnrMarginRocDownstream", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 15),
		},
		Access:  CreatedByOnu,
