...
func init() {
	tcontBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: Uint16Field("AllocId", UnsignedIntegerAttributeType, 65535, mapset.NewSetWith(Read, Write), false, false, 1),
			2: ByteField("Deprecated", UnsignedIntegerAttributeType, 1, mapset.NewSetWith(Read), false, false, 2),
