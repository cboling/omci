...
func init() {
	ethernetframeextendedpm64bitBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint64Field("DropEvents", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4:  Uint64Field("Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5:  Uint64Field("Frames", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint64Field("BroadcastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint64Field("MulticastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint64Field("CrcErroredFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint64Field("UndersizeFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint64Field("OversizeFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint64Field("Frames64Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
			12: Uint64Field("Frames65To127Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 12),
			13: Uint64Field("Frames128To255Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 13),
			14: Uint64Field("Frames256To511Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 14),
			15: Uint64Field("Frames512To1023Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 15),
			16: Uint64Field("Frames1024To1518Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 16),
		},
		Access:  CreatedByOlt,
