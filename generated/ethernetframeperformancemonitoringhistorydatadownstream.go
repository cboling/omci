...
func init() {
	ethernetframeperformancemonitoringhistorydatadownstreamBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  Uint32Field("Packets", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint32Field("BroadcastPackets", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("MulticastPackets", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint32Field("CrcErroredPackets", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint32Field("UndersizePackets", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("OversizePackets", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint32Field("Packets64Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
			12: Uint32Field("Packets65To127Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 12),
			13: Uint32Field("Packets128To255Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 13),
			14: Uint32Field("Packets256To511Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 14),
