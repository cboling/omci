...
func init() {
	physicalpathterminationpointmocauniBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("LoopbackConfiguration", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 1),
			...
			4:  Uint16Field("MaxFrameSize", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 4),
			5:  ByteField("Arc", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), true, true, false, 5),
			...
			13: Uint16Field("RfChannel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 13),
			14: Uint16Field("LastOperationalFrequency", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 14),
		},
		Access:  CreatedByOnu,
