...
func init() {
	vdsl2lineinventoryandstatusdatapart3BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("DownstreamLineAttenuationPerBand", OctetsAttributeType, 3, toOctets("AAAA"), mapset.NewSetWith(Read), false, false, false, 1),
			2: Uint32Field("UpstreamLineAttenuationPerBand", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 2),
			3: MultiByteField("DownstreamSignalAttenuationPerBand", OctetsAttributeType, 3, toOctets("AAAA"), mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint32Field("UpstreamSignalAttenuationPerBand", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: MultiByteField("DownstreamSnrMarginPerBand", OctetsAttributeType, 3, toOctets("AAAA"), mapset.NewSetWith(Read), false, false, false, 5),
			6: Uint32Field("UpstreamSnrMarginPerBand", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
		},
		Access:  CreatedByOnu,
