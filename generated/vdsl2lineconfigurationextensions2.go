...
func init() {
	vdsl2lineconfigurationextensions2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("SosTimeDownstream", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 1),
			2:  ByteField("SosTimeUpstream", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 2),
			3:  ByteField("SosDegradedTonesThresholdDownstream", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 3),
			4:  ByteField("SosDegradedTonesThresholdUpstream", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 4),
			5:  Uint16Field("SosCrcThresholdDownstream", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 5),
			6:  Uint16Field("SosCrcThresholdUpstream", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 6),
			7:  ByteField("MaxSosDownstream", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 7),
			8:  ByteField("MaxSosUpstream", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 8),
			9:  Uint16Field("SnrMaxOffsetDownstream", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 9),
