...
func init() {
	multicastgeminterworkingterminationpointBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  Uint16Field("GemPortNetworkCtpConnectivityPointer", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 1),
			2:  ByteField("InterworkingOption", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 2),
			3:  Uint16Field("ServiceProfilePointer", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 3),
			4:  Uint16Field("NotUsed1", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 4),
			5:  ByteField("PptpCounter", UnsignedIntegerAttributeType, 255, mapset.NewSetWith(Read), false, true, false, 5),
			6:  ByteField("OperationalState", EnumerationAttributeType, 0, mapset.NewSetWith(Read), true, true, false, 6),
			7:  Uint16Field("GalProfilePointer", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 7),
			8:  ByteField("NotUsed2", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 8),
			9:  TableField("Ipv4MulticastAddressTable", TableAttributeType, TableInfo{nil, 12}, mapset.NewSetWith(Read, Write), false, false, false, 9),
			10: TableField("Ipv6MulticastAddressTable", TableAttributeType, TableInfo{nil, 24}, mapset.NewSetWith(Read, Write), false, true, false, 10),
		},
		Access:  CreatedByOlt,
