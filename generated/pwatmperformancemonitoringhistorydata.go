...
func init() {
	pwatmperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("DownstreamMissingPacketsCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint32Field("DownstreamReorderedPacketsCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 4),
			5: Uint32Field("DownstreamMisorderedPacketsCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6: Uint32Field("UpstreamTimeoutPacketsCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7: Uint32Field("UpstreamTransmittedCellsCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8: Uint32Field("UpstreamDroppedCellsCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
			9: Uint32Field("UpstreamReceivedCellsCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
		},
		Access:  CreatedByOlt,
