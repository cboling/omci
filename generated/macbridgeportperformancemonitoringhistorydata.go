...
func init() {
	macbridgeportperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("ForwardedFrameCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint32Field("DelayExceededDiscardCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint32Field("MaximumTransmissionUnitMtuExceededDiscardCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6: Uint32Field("ReceivedFrameCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7: Uint32Field("ReceivedAndDiscardedCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
		},
		Access:  CreatedByOlt,
