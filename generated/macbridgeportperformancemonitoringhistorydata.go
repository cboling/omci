...
func init() {
	macbridgeportperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("ForwardedFrameCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint32Field("DelayExceededDiscardCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5: Uint32Field("MaximumTransmissionUnitMtuExceededDiscardCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6: Uint32Field("ReceivedFrameCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7: Uint32Field("ReceivedAndDiscardedCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
		},
