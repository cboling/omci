...
func init() {
	xtudatagatheringconfigurationBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: TableField("LoggingDepthEventPercentagePerEventVtuOLoggingDepthEventPercentageOiTable", TableAttributeType, TableInfo{nil, 2}, mapset.NewSetWith(Read, Write), false, true, 1),
			2: TableField("LoggingDepthEventPercentagePerEventVtuRLoggingDepthEventPercentageRiTable", TableAttributeType, TableInfo{nil, 2}, mapset.NewSetWith(Read, Write), false, true, 2),
			3: Uint16Field("LoggingDepthForVtuOReportingVtuRLoggingDepthReportingO", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 3),
			4: Uint16Field("LoggingDepthForVtuRReportingVtuRLoggingDepthReportingR", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 4),
			5: ByteField("LoggingDataReportNewerEventsFirstVtuRLoggingReportNewerFirst", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 5),
		},
		Access:  CreatedByOlt,
