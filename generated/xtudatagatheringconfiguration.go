...
func init() {
	xtudatagatheringconfigurationBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: TableField("LoggingDepthEventPercentagePerEventVtuOLoggingDepthEventPercentageOiTable", TableInfo{0, 2}, mapset.NewSetWith(Read, Write), false, true, false, 1),
			2: TableField("LoggingDepthEventPercentagePerEventVtuRLoggingDepthEventPercentageRiTable", TableInfo{0, 2}, mapset.NewSetWith(Read, Write), false, true, false, 2),
