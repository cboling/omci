...
func init() {
	macbridgeserviceprofileBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  Uint16Field("MaxAge", 1536, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, false, 5),
			6:  Uint16Field("HelloTime", 256, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, false, 6),
			7:  Uint16Field("ForwardDelay", 1024, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, false, 7),
			...
			10: Uint32Field("DynamicFilteringAgeingTime", 300, mapset.NewSetWith(Read, SetByCreate, Write), false, false, true, false, 10),
		},
		Access:  CreatedByOlt,
