...
func init() {
	macbridgeserviceprofileBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("SpanningTreeInd", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2:  ByteField("LearningInd", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3:  ByteField("PortBridgingInd", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 3),
			4:  Uint16Field("Priority", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5:  Uint16Field("MaxAge", UnsignedIntegerAttributeType, 1536, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 5),
			6:  Uint16Field("HelloTime", UnsignedIntegerAttributeType, 256, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 6),
			7:  Uint16Field("ForwardDelay", UnsignedIntegerAttributeType, 1024, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 7),
			8:  ByteField("UnknownMacAddressDiscard", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 8),
			9:  ByteField("MacLearningDepth", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 9),
			10: Uint32Field("DynamicFilteringAgeingTime", UnsignedIntegerAttributeType, 300, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 10),
		},
		Access:  CreatedByOlt,
