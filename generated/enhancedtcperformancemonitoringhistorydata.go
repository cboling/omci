...
func init() {
	enhancedtcperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2:  Uint16Field("ThresholdData64BitId", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 2),
			...
			6:  Uint64Field("TransmittedXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint64Field("FragmentXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 7),
			8:  Uint64Field("XgemHecLostWordsCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 8),
			9:  Uint64Field("XgemKeyErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint64Field("XgemHecErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			...
			13: Uint32Field("LodsEventCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 13),
