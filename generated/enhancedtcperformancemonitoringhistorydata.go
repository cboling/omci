...
func init() {
	enhancedtcperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			6:  Uint64Field("TransmittedXgemFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint64Field("FragmentXgemFrames", 0, mapset.NewSetWith(Read), false, true, true, false, 7),
			8:  Uint64Field("XgemHecLostWordsCount", 0, mapset.NewSetWith(Read), false, true, true, false, 8),
			9:  Uint64Field("XgemKeyErrors", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint64Field("XgemHecErrorCount", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			...
			13: Uint32Field("LodsEventCount", 0, mapset.NewSetWith(Read), false, true, true, false, 13),
