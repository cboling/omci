...
func init() {
	anigBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("SrIndication", EnumerationAttributeType, 0, mapset.NewSetWith(Read), false, false, 1),
			2:  Uint16Field("TotalTcontNumber", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 2),
			3:  Uint16Field("GemBlockLength", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4:  ByteField("PiggybackDbaReporting", EnumerationAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  ByteField("Deprecated", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  ByteField("SignalFailThreshold", UnsignedIntegerAttributeType, 5, mapset.NewSetWith(Read, Write), false, false, 6),
			7:  ByteField("SignalDegradeThreshold", UnsignedIntegerAttributeType, 9, mapset.NewSetWith(Read, Write), false, false, 7),
			8:  ByteField("Arc", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), true, true, 8),
			9:  ByteField("ArcInterval", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 9),
			10: Uint16Field("OpticalSignalLevel", SignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 10),
			11: ByteField("LowerOpticalThreshold", SignedIntegerAttributeType, 255, mapset.NewSetWith(Read, Write), false, true, 11),
			12: ByteField("UpperOpticalThreshold", SignedIntegerAttributeType, 255, mapset.NewSetWith(Read, Write), false, true, 12),
			13: Uint16Field("OnuResponseTime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 13),
			14: Uint16Field("TransmitOpticalLevel", SignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 14),
			15: ByteField("LowerTransmitPowerThreshold", SignedIntegerAttributeType, 129, mapset.NewSetWith(Read, Write), false, true, 15),
			16: ByteField("UpperTransmitPowerThreshold", SignedIntegerAttributeType, 129, mapset.NewSetWith(Read, Write), false, true, 16),
		},
		Access:  CreatedByOnu,
