...
func init() {
	anigBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			6:  ByteField("SignalFailThreshold", 5, mapset.NewSetWith(Read, Write), false, false, false, false, 6),
			7:  ByteField("SignalDegradeThreshold", 9, mapset.NewSetWith(Read, Write), false, false, false, false, 7),
			...
			11: ByteField("LowerOpticalThreshold", 255, mapset.NewSetWith(Read, Write), false, false, true, false, 11),
			12: ByteField("UpperOpticalThreshold", 255, mapset.NewSetWith(Read, Write), false, false, true, false, 12),
			...
			15: ByteField("LowerTransmitPowerThreshold", 129, mapset.NewSetWith(Read, Write), false, false, true, false, 15),
			16: ByteField("UpperTransmitPowerThreshold", 129, mapset.NewSetWith(Read, Write), false, false, true, false, 16),
		},
		Access:  CreatedByOnu,
