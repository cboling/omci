...
func init() {
	tcpudpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint16Field("SocketFailed", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint16Field("ListenFailed", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint16Field("BindFailed", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6: Uint16Field("AcceptFailed", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7: Uint16Field("SelectFailed", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
		},
		Access:  CreatedByOlt,
