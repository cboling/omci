...
func init() {
	tcpudpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint16Field("SocketFailed", 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint16Field("ListenFailed", 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: Uint16Field("BindFailed", 0, mapset.NewSetWith(Read), false, false, false, 5),
			6: Uint16Field("AcceptFailed", 0, mapset.NewSetWith(Read), false, false, false, 6),
			7: Uint16Field("SelectFailed", 0, mapset.NewSetWith(Read), false, false, false, 7),
		},
	}
}
