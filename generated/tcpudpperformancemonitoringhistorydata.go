...
func init() {
	tcpudpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint16Field("SocketFailed", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint16Field("ListenFailed", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5: Uint16Field("BindFailed", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
