...
func init() {
	enhancedsecuritycontrolBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  TableField("OnuRandomChallengeTable", TableAttributeType, TableInfo{nil, 16}, mapset.NewSetWith(Read), true, false, false, 5),
			6:  TableField("OnuAuthenticationResultTable", TableAttributeType, TableInfo{nil, 16}, mapset.NewSetWith(Read), true, false, false, 6),
