...
func init() {
	enhancedsecuritycontrolBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  MultiByteField("OltCryptoCapabilities", OctetsAttributeType, 16, nil, mapset.NewSetWith(Write), false, false, 1),
			2:  TableField("OltRandomChallengeTable", TableAttributeType, TableInfo{nil, 17}, mapset.NewSetWith(Read, Write), false, false, 2),
			3:  ByteField("OltChallengeStatus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4:  ByteField("OnuSelectedCryptoCapabilities", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  TableField("OnuRandomChallengeTable", TableAttributeType, TableInfo{nil, 16}, mapset.NewSetWith(Read), true, false, 5),
			6:  TableField("OnuAuthenticationResultTable", TableAttributeType, TableInfo{nil, 16}, mapset.NewSetWith(Read), true, false, 6),
			7:  TableField("OltAuthenticationResultTable", TableAttributeType, TableInfo{nil, 17}, mapset.NewSetWith(Read, Write), false, false, 7),
			8:  ByteField("OltResultStatus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 8),
			9:  ByteField("OnuAuthenticationStatus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), true, false, 9),
			10: MultiByteField("MasterSessionKeyName", OctetsAttributeType, 16, nil, mapset.NewSetWith(Read), false, false, 10),
			11: TableField("BroadcastKeyTable", TableAttributeType, TableInfo{nil, 18}, mapset.NewSetWith(Read, Write), false, true, 11),
			12: Uint16Field("EffectiveKeyLength", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 12),
		},
		Access:  CreatedByOnu,
