...
func init() {
	enhancedsecuritycontrolBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2:  TableField("OltRandomChallengeTable", TableInfo{0, 17}, mapset.NewSetWith(Read, Write), false, false, false, 2),
			...
			5:  TableField("OnuRandomChallengeTable", TableInfo{0, 16}, mapset.NewSetWith(Read), true, false, false, 5),
			6:  TableField("OnuAuthenticationResultTable", TableInfo{0, 16}, mapset.NewSetWith(Read), true, false, false, 6),
			7:  TableField("OltAuthenticationResultTable", TableInfo{0, 17}, mapset.NewSetWith(Read, Write), false, false, false, 7),
			...
			11: TableField("BroadcastKeyTable", TableInfo{0, 18}, mapset.NewSetWith(Read, Write), false, true, false, 11),
