...
func init() {
	mocaethernetperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("IncomingUnicastPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 3),
			4:  Uint32Field("IncomingDiscardedPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 4),
			5:  Uint32Field("IncomingErroredPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 5),
			6:  Uint32Field("IncomingUnknownPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 6),
			7:  Uint32Field("IncomingMulticastPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 7),
			8:  Uint32Field("IncomingBroadcastPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 8),
			9:  Uint32Field("IncomingOctets", 0, mapset.NewSetWith(Read), false, true, true, false, 9),
			10: Uint32Field("OutgoingUnicastPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 10),
			11: Uint32Field("OutgoingDiscardedPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 11),
			12: Uint32Field("OutgoingErroredPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 12),
			13: Uint32Field("OutgoingUnknownPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 13),
			14: Uint32Field("OutgoingMulticastPackets", 0, mapset.NewSetWith(Read), false, true, true, false, 14),
