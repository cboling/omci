...
func init() {
	mocaethernetperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("IncomingUnicastPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 3),
			4:  Uint32Field("IncomingDiscardedPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 4),
			5:  Uint32Field("IncomingErroredPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 5),
			6:  Uint32Field("IncomingUnknownPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 6),
			7:  Uint32Field("IncomingMulticastPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 7),
			8:  Uint32Field("IncomingBroadcastPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 8),
			9:  Uint32Field("IncomingOctets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 9),
			10: Uint32Field("OutgoingUnicastPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 10),
			11: Uint32Field("OutgoingDiscardedPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 11),
			12: Uint32Field("OutgoingErroredPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 12),
			13: Uint32Field("OutgoingUnknownPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 13),
			14: Uint32Field("OutgoingMulticastPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 14),
			15: Uint32Field("OutgoingBroadcastPackets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 15),
			16: Uint32Field("OutgoingOctets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 16),
		},
		Access:  CreatedByOlt,
