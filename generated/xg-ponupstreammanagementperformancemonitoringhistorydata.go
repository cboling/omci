...
func init() {
	xgponupstreammanagementperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("UpstreamPloamMessageCount", 0, mapset.NewSetWith(Read), false, false, true, 3),
			4: Uint32Field("SerialNumberOnuMessageCount", 0, mapset.NewSetWith(Read), false, false, true, 4),
			5: Uint32Field("RegistrationMessageCount", 0, mapset.NewSetWith(Read), false, false, true, 5),
			6: Uint32Field("KeyReportMessageCount", 0, mapset.NewSetWith(Read), false, false, true, 6),
			7: Uint32Field("AcknowledgeMessageCount", 0, mapset.NewSetWith(Read), false, false, true, 7),
			8: Uint32Field("SleepRequestMessageCount", 0, mapset.NewSetWith(Read), false, false, true, 8),
		},
	}
}
