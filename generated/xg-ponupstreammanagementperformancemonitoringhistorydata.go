...
func init() {
	xgponupstreammanagementperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("UpstreamPloamMessageCount", 0, mapset.NewSetWith(Read), false, true, true, false, 3),
			4: Uint32Field("SerialNumberOnuMessageCount", 0, mapset.NewSetWith(Read), false, true, true, false, 4),
			5: Uint32Field("RegistrationMessageCount", 0, mapset.NewSetWith(Read), false, true, true, false, 5),
			6: Uint32Field("KeyReportMessageCount", 0, mapset.NewSetWith(Read), false, true, true, false, 6),
