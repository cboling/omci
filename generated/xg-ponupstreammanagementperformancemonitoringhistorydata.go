...
func init() {
	xgponupstreammanagementperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("UpstreamPloamMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 3),
			4: Uint32Field("SerialNumberOnuMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 4),
			5: Uint32Field("RegistrationMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 5),
			6: Uint32Field("KeyReportMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 6),
			7: Uint32Field("AcknowledgeMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 7),
			8: Uint32Field("SleepRequestMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 8),
		},
		Access:  CreatedByOlt,
