...
func init() {
	xdslxturchannelperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("CorrectedBlocks", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint32Field("UncorrectedBlocks", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5: Uint32Field("TransmittedBlocks", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6: Uint32Field("ReceivedBlocks", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
