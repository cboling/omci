...
func init() {
	callcontrolperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("CallSetupFailures", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint32Field("CallSetupTimer", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5: Uint32Field("CallTerminateFailures", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
