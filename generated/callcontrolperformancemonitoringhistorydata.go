...
func init() {
	callcontrolperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("CallSetupFailures", 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint32Field("CallSetupTimer", 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: Uint32Field("CallTerminateFailures", 0, mapset.NewSetWith(Read), false, false, false, 5),
			6: Uint32Field("AnalogPortReleases", 0, mapset.NewSetWith(Read), false, false, false, 6),
			7: Uint32Field("AnalogPortOffHookTimer", 0, mapset.NewSetWith(Read), false, false, false, 7),
		},
	}
}
