...
func init() {
	callcontrolperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("CallSetupFailures", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint32Field("CallSetupTimer", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint32Field("CallTerminateFailures", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6: Uint32Field("AnalogPortReleases", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7: Uint32Field("AnalogPortOffHookTimer", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
		},
		Access:  CreatedByOlt,
