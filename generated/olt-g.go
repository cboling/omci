...
func init() {
	oltgBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("OltVendorId", StringAttributeType, 4, toOctets("ICAgIA=="), mapset.NewSetWith(Read, Write), false, false, 1),
			2: MultiByteField("EquipmentId", StringAttributeType, 20, toOctets("ICAgICAgICAgICAgICAgICAgICA="), mapset.NewSetWith(Read, Write), false, false, 2),
			3: MultiByteField("Version", StringAttributeType, 14, toOctets("MAAAAAAAAAAAAAAAAAA="), mapset.NewSetWith(Read, Write), false, false, 3),
			4: MultiByteField("TimeOfDayInformation", OctetsAttributeType, 14, toOctets("AAAAAAAAAAAAAAAAAAA="), mapset.NewSetWith(Read, Write), false, true, 4),
		},
		Access:  CreatedByOnu,
