...
func init() {
	mgcperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("ReceivedMessages", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4:  Uint32Field("ReceivedOctets", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5:  Uint32Field("SentMessages", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint32Field("SentOctets", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("ProtocolErrors", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint32Field("TransportLosses", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  ByteField("LastDetectedEvent", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
