...
func init() {
	mgcperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("ReceivedMessages", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  Uint32Field("ReceivedOctets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  Uint32Field("SentMessages", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint32Field("SentOctets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint32Field("ProtocolErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint32Field("TransportLosses", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  ByteField("LastDetectedEvent", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint32Field("LastDetectedEventTime", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
			11: Uint32Field("LastDetectedResetTime", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 11),
		},
		Access:  CreatedByOlt,
