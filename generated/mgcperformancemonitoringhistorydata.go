...
func init() {
	mgcperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("ReceivedMessages", 0, mapset.NewSetWith(Read), false, false, false, 3),
			4:  Uint32Field("ReceivedOctets", 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  Uint32Field("SentMessages", 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  Uint32Field("SentOctets", 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint32Field("ProtocolErrors", 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  Uint32Field("TransportLosses", 0, mapset.NewSetWith(Read), false, false, false, 8),
			9:  ByteField("LastDetectedEvent", 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint32Field("LastDetectedEventTime", 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: Uint32Field("LastDetectedResetTime", 0, mapset.NewSetWith(Read), false, false, false, 11),
		},
	}
}
