...
func init() {
	sipuserdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  Uint16Field("SipAgentPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2:  Uint16Field("UserPartAor", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3:  MultiByteField("SipDisplayName", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, 3),
			4:  Uint16Field("UsernameAndPassword", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5:  Uint16Field("VoicemailServerSipUri", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 5),
			6:  Uint32Field("VoicemailSubscriptionExpirationTime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 6),
			7:  Uint16Field("NetworkDialPlanPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 7),
			8:  Uint16Field("ApplicationServicesProfilePointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 8),
			9:  Uint16Field("FeatureCodePointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 9),
			10: Uint16Field("PptpPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 10),
			11: ByteField("ReleaseTimer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 11),
			12: ByteField("ReceiverOffHookRohTimer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 12),
		},
		Access:  CreatedByOlt,
