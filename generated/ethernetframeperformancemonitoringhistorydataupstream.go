...
func NewEthernetFramePerformanceMonitoringHistoryDataUpstream(params ...ParamData) (IManagedEntityDefinition, error) {
	...
	entity := BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			8:  Uint32Field("CrcErroredPackets", 0, Read, false, false, false, false),
			9:  Uint32Field("UndersizePackets", 0, Read, false, false, false, false),
			10: Uint32Field("OversizePackets", 0, Read, false, false, false, false),
