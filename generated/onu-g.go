...
func init() {
	onugBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  MultiByteField("VendorId", 4, toOctets("ICAgIA=="), mapset.NewSetWith(Read), false, false, false, false, 1),
			2:  MultiByteField("Version", 14, toOctets("MAAAAAAAAAAAAAAAAAA="), mapset.NewSetWith(Read), false, false, false, false, 2),
			3:  MultiByteField("SerialNumber", 8, toOctets("AAAAAAAAAAA="), mapset.NewSetWith(Read), false, false, false, false, 3),
			...
			10: MultiByteField("LogicalOnuId", 24, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), mapset.NewSetWith(Read), false, false, true, false, 10),
			11: MultiByteField("LogicalPassword", 12, toOctets("AAAAAAAAAAAAAAAA"), mapset.NewSetWith(Read), false, false, true, false, 11),
