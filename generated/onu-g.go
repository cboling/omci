...
func init() {
	onugBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  MultiByteField("VendorId", StringAttributeType, 4, toOctets("ICAgIA=="), mapset.NewSetWith(Read), false, false, false, 1),
			2:  MultiByteField("Version", StringAttributeType, 14, toOctets("MAAAAAAAAAAAAAAAAAA="), mapset.NewSetWith(Read), false, false, false, 2),
			3:  MultiByteField("SerialNumber", OctetsAttributeType, 8, toOctets("AAAAAAAAAAA="), mapset.NewSetWith(Read), false, false, false, 3),
			4:  ByteField("TrafficManagementOption", EnumerationAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  ByteField("Deprecated", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, true, 5),
			6:  ByteField("BatteryBackup", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 6),
			7:  ByteField("AdministrativeState", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 7),
			8:  ByteField("OperationalState", EnumerationAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 8),
			9:  ByteField("OnuSurvivalTime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 9),
			10: MultiByteField("LogicalOnuId", OctetsAttributeType, 24, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"), mapset.NewSetWith(Read), false, true, false, 10),
			11: MultiByteField("LogicalPassword", OctetsAttributeType, 12, toOctets("AAAAAAAAAAAAAAAA"), mapset.NewSetWith(Read), false, true, false, 11),
			12: ByteField("CredentialsStatus", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 12),
			13: Uint16Field("ExtendedTcLayerOptions", BitFieldAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 13),
		},
		Access:  CreatedByOnu,
