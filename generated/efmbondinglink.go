...
func init() {
	efmbondinglinkBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: Uint16Field("AssociatedGroupMeId", 0, Read|SetByCreate|Write, false, false, false, 1),
			2: ByteField("LinkAlarmEnable", 0, Read|SetByCreate|Write, false, false, false, 2),
		},
	}
}
