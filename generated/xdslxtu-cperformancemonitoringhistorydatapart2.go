...
func init() {
	xdslxtucperformancemonitoringhistorydatapart2BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint16Field("LeftrDefectSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint32Field("ErrorFreeBitsCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint32Field("MinimumErrorFreeThroughputMineftr", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
		},
		Access:  CreatedByOlt,
