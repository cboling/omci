...
func NewFastXtuCPerformanceMonitoringHistoryData(params ...ParamData) (omci.IManagedEntity, error) {
	...
	entity := omci.BaseManagedEntity{
		...
		Attributes: []omci.IAttribute{
			...
			omci.NewUint32Field("SuccessfulFraCounter", 0, omci.Read),
			omci.NewUint32Field("SuccessfulRpaCounter", 0, omci.Read),
			omci.NewUint32Field("SuccessfulTigaCounter", 0, omci.Read),
		},
	}
	entity.ComputeAttributeMask()
	return &FastXtuCPerformanceMonitoringHistoryData{entity}, nil
}
