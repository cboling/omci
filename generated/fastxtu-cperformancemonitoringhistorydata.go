...
func init() {
	fastxtucperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("SuccessfulFraCounter", 0, Read, false, false, false, 3),
			4: Uint32Field("SuccessfulRpaCounter", 0, Read, false, false, true, 4),
			5: Uint32Field("SuccessfulTigaCounter", 0, Read, false, false, true, 5),
		},
	}
}
