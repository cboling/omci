...
func init() {
	fastxtucperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("SuccessfulFraCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint32Field("SuccessfulRpaCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 4),
			5: Uint32Field("SuccessfulTigaCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 5),
		},
		Access:  CreatedByOlt,
