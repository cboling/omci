...
func init() {
	fastxtucperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("SuccessfulFraCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint32Field("SuccessfulRpaCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 4),
			5: Uint32Field("SuccessfulTigaCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 5),
		},
		Access:  CreatedByOlt,
