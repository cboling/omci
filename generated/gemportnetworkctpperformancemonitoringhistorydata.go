...
func init() {
	gemportnetworkctpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("TransmittedGemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint32Field("ReceivedGemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint64Field("ReceivedPayloadBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6: Uint64Field("TransmittedPayloadBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7: Uint32Field("EncryptionKeyErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, 7),
		},
		Access:  CreatedByOlt,
