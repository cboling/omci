...
func init() {
	gemportnetworkctpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("TransmittedGemFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint32Field("ReceivedGemFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5: Uint64Field("ReceivedPayloadBytes", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
