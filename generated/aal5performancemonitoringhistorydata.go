...
func NewAal5PerformanceMonitoringHistoryData(params ...ParamData) (omci.IManagedEntity, error) {
	...
	entity := omci.BaseManagedEntity{
		...
		Attributes: []omci.IAttribute{
			...
			omci.NewUint32Field("SumOfInvalidCsFieldErrors", 0, omci.Read),
			omci.NewUint32Field("CrcViolations", 0, omci.Read),
			omci.NewUint32Field("ReassemblyTimerExpirations", 0, omci.Read),
