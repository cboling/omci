...
func init() {
	aal5performancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("SumOfInvalidCsFieldErrors", 0, Read, false, false, false, 3),
			4: Uint32Field("CrcViolations", 0, Read, false, false, false, 4),
			5: Uint32Field("ReassemblyTimerExpirations", 0, Read, false, false, false, 5),
			6: Uint32Field("BufferOverflows", 0, Read, false, false, false, 6),
			7: Uint32Field("EncapProtocolErrors", 0, Read, false, false, false, 7),
		},
	}
}
