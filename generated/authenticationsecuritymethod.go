...
func init() {
	authenticationsecuritymethodBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2: MultiByteField("Username1", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, false, 2),
			3: MultiByteField("Password", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, false, 3),
			4: MultiByteField("Realm", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, false, 4),
			5: MultiByteField("Username2", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, true, false, 5),
		},
		Access:  CreatedByOlt,
