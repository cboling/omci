...
func init() {
	authenticationsecuritymethodBME := &BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("ValidationScheme", 0, Read|Write, false, false, false),
			2: MultiByteField("Username1", 25, nil, Read|Write, false, false, false),
			3: MultiByteField("Password", 25, nil, Read|Write, false, false, false),
			4: MultiByteField("Realm", 25, nil, Read|Write, false, false, false),
			5: MultiByteField("Username2", 25, nil, Read|Write, false, false, true),
		},
	}
}
