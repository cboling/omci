...
func init() {
	dot1xperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("EapolFramesReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4:  Uint32Field("EapolFramesTransmitted", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5:  Uint32Field("EapolStartFramesReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint32Field("EapolLogoffFramesReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("InvalidEapolFramesReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint32Field("EapRespIdFramesReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint32Field("EapResponseFramesReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("EapInitialRequestFramesTransmitted", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint32Field("EapRequestFramesTransmitted", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
			12: Uint32Field("EapLengthErrorFramesReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 12),
