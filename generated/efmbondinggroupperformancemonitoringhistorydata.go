...
func init() {
	efmbondinggroupperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("RxBadFragments", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4:  Uint32Field("RxLostFragments", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  Uint32Field("RxLostStarts", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  Uint32Field("RxLostEnds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint32Field("RxFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  Uint32Field("TxFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
			9:  Uint64Field("RxBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint64Field("TxBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: Uint32Field("TxDiscardedFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 11),
			12: Uint32Field("TxDiscardedBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 12),
		},
		Access:  CreatedByOlt,
