...
func init() {
	efmbondinggroupperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("RxBadFragments", 0, Read, false, false, false, 3),
			4:  Uint32Field("RxLostFragments", 0, Read, false, false, false, 4),
			5:  Uint32Field("RxLostStarts", 0, Read, false, false, false, 5),
			6:  Uint32Field("RxLostEnds", 0, Read, false, false, false, 6),
			7:  Uint32Field("RxFrames", 0, Read, false, false, false, 7),
			8:  Uint32Field("TxFrames", 0, Read, false, false, false, 8),
			9:  Uint64Field("RxBytes", 0, Read, false, false, false, 9),
			10: Uint64Field("TxBytes", 0, Read, false, false, false, 10),
			11: Uint32Field("TxDiscardedFrames", 0, Read, false, false, false, 11),
			12: Uint32Field("TxDiscardedBytes", 0, Read, false, false, false, 12),
		},
	}
}
