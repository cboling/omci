...
func init() {
	twdmchannelxgemperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint64Field("TotalTransmittedXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  Uint64Field("TransmittedXgemFramesWithLfBitNotSet", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  Uint64Field("TotalReceivedXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint64Field("ReceivedXgemFramesWithXgemHeaderHecErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint64Field("FsWordsLostToXgemHeaderHecErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint64Field("XgemEncryptionKeyErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint64Field("TotalTransmittedBytesInNonIdleXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint64Field("TotalReceivedBytesInNonIdleXgemFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
		},
		Access:  CreatedByOlt,
