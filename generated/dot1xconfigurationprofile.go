...
func NewDot1XConfigurationProfile(params ...ParamData) (IManagedEntityDefinition, error) {
	...
	entity := BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			4: MultiByteField("SharedSecretAuth1", 25, nil, Read|Write),
			5: Uint16Field("AuthServer2", 0, Read|Write),
			6: MultiByteField("SharedSecretAuth2", 25, nil, Read|Write),
			7: Uint16Field("AuthServer3", 0, Read|Write),
			8: MultiByteField("SharedSecretAuth3", 25, nil, Read|Write),
