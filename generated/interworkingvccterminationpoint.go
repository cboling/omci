...
func NewInterworkingVccTerminationPoint(params ...ParamData) (IManagedEntityDefinition, error) {
	...
	entity := BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: Uint16Field("VciValue", 0, Read|SetByCreate|Write),
			2: Uint16Field("VpNetworkCtpConnectivityPointer", 0, Read|SetByCreate|Write),
			3: ByteField("Deprecated1", 0, Read|SetByCreate|Write),
			4: Uint16Field("Deprecated2", 0, Read|SetByCreate|Write),
			5: Uint16Field("Aal5ProfilePointer", 0, Read|SetByCreate|Write),
