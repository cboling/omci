...
func init() {
	vdsl2lineconfigurationextensions3BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("Ripolicyds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 1),
			2:  ByteField("Ripolicyus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 2),
			3:  ByteField("ReinitTimeThresholdds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 3),
			4:  ByteField("ReinitTimeThresholdus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 4),
			5:  ByteField("Rxrefvnsfus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 5),
			6:  ByteField("Txrefvnsfds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 6),
			7:  ByteField("RtxModeds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 7),
			8:  ByteField("RtxModeus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 8),
			9:  ByteField("LeftrThresh", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 9),
			10: ByteField("MaxdelayoctetSplitParameterMdosplit", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 10),
			11: ByteField("AttndrMethodAttndrMethod", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 11),
			12: ByteField("AttndrMaxdelayoctetSplitParameterAttndrMdosplit", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 12),
		},
		Access:  CreatedByOlt,
