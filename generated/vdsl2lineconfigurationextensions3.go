...
func init() {
	vdsl2lineconfigurationextensions3BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("Ripolicyds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 1),
			2:  ByteField("Ripolicyus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 2),
			3:  ByteField("ReinitTimeThresholdds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 3),
			4:  ByteField("ReinitTimeThresholdus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 4),
			5:  ByteField("Rxrefvnsfus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 5),
			6:  ByteField("Txrefvnsfds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 6),
			7:  ByteField("RtxModeds", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 7),
			8:  ByteField("RtxModeus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 8),
			9:  ByteField("LeftrThresh", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 9),
			10: ByteField("MaxdelayoctetSplitParameterMdosplit", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 10),
			11: ByteField("AttndrMethodAttndrMethod", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 11),
			12: ByteField("AttndrMaxdelayoctetSplitParameterAttndrMdosplit", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 12),
		},
		Access:  CreatedByOlt,
