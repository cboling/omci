...
func init() {
	macbridgeportfilterpreassigntableBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("Ipv4MulticastFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			2:  ByteField("Ipv6MulticastFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
			3:  ByteField("Ipv4BroadcastFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4:  ByteField("RarpFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 4),
			5:  ByteField("IpxFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 5),
			6:  ByteField("NetbeuiFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 6),
			7:  ByteField("AppletalkFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 7),
			8:  ByteField("BridgeManagementInformationFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 8),
			9:  ByteField("ArpFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 9),
			10: ByteField("PointToPointProtocolOverEthernetPppoeBroadcastFiltering", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 10),
		},
		Access:  CreatedByOnu,
