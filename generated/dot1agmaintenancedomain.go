...
func init() {
	dot1agmaintenancedomainBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("MdLevel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2: ByteField("MdNameFormat", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3: MultiByteField("MdName1MdName2", OctetsAttributeType, 25, nil, mapset.NewSetWith(Read, Write), false, false, 3),
			4: ByteField("MaintenanceDomainIntermediatePointHalfFunctionMhfCreation", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5: ByteField("SenderIdPermission", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 5),
		},
		Access:  CreatedByOlt,
