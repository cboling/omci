...
func init() {
	physicalpathterminationpointvideoaniBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  ByteField("FrequencyRangeLow", 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  ByteField("FrequencyRangeHigh", 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  ByteField("SignalCapability", 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  ByteField("OpticalSignalLevel", 0, mapset.NewSetWith(Read), false, false, true, 8),
			9:  ByteField("PilotSignalLevel", 0, mapset.NewSetWith(Read), false, false, true, 9),
			10: ByteField("SignalLevelMin", 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: ByteField("SignalLevelMax", 0, mapset.NewSetWith(Read), false, false, false, 11),
			12: Uint32Field("PilotFrequency", 0, mapset.NewSetWith(Read, Write), false, false, true, 12),
			13: ByteField("AgcMode", 0, mapset.NewSetWith(Read, Write), false, false, true, 13),
			14: ByteField("AgcSetting", 0, mapset.NewSetWith(Read, Write), false, false, true, 14),
			15: ByteField("VideoLowerOpticalThreshold", 0, mapset.NewSetWith(Read, Write), false, false, true, 15),
			16: ByteField("VideoUpperOpticalThreshold", 0, mapset.NewSetWith(Read, Write), false, false, true, 16),
		},
	}
}
