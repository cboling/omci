...
func init() {
	recommonamplifierparametersBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("Gain", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 1),
			2:  ByteField("LowerGainThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 2),
			3:  ByteField("UpperGainThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 3),
			4:  ByteField("TargetGain", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 4),
			5:  Uint16Field("DeviceTemperature", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 5),
			6:  ByteField("LowerDeviceTemperatureThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 6),
			7:  ByteField("UpperDeviceTemperatureThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 7),
			8:  ByteField("DeviceBiasCurrent", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 8),
			9:  Uint16Field("AmplifierSaturationOutputPower", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 9),
			10: ByteField("AmplifierNoiseFigure", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 10),
			11: ByteField("AmplifierSaturationGain", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 11),
		},
		Access:  CreatedByOnu,
