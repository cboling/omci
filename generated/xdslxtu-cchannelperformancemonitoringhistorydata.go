...
func init() {
	xdslxtucchannelperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("CorrectedBlocks", 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint32Field("UncorrectedBlocks", 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: Uint32Field("TransmittedBlocks", 0, mapset.NewSetWith(Read), false, false, false, 5),
			6: Uint32Field("ReceivedBlocks", 0, mapset.NewSetWith(Read), false, false, false, 6),
			7: Uint16Field("CodeViolations", 0, mapset.NewSetWith(Read), false, false, false, 7),
			8: Uint16Field("ForwardErrorCorrections", 0, mapset.NewSetWith(Read), false, false, false, 8),
		},
	}
}
