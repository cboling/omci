...
func init() {
	tcadaptorperformancemonitoringhistorydataxdslBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint16Field("NearEndHecViolationCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4:  Uint32Field("NearEndDelineatedTotalCellCountCdP", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  Uint32Field("NearEndUserTotalCellCountCuP", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  Uint16Field("NearEndIdleCellBitErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint16Field("FarEndHecViolationCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  Uint32Field("FarEndDelineatedTotalCellCountCdPfe", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
			9:  Uint32Field("FarEndUserTotalCellCountCuPfe", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint16Field("FarEndIdleCellBitErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
		},
		Access:  CreatedByOlt,
