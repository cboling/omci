...
func init() {
	unigBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: Uint16Field("Deprecated", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			2: ByteField("AdministrativeState", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
			3: ByteField("ManagementCapability", EnumerationAttributeType, 0, mapset.NewSetWith(Read), false, true, 3),
			4: Uint16Field("NonOmciManagementIdentifier", PointerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 4),
			5: Uint16Field("RelayAgentOptions", PointerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 5),
		},
		Access:  CreatedByOnu,
