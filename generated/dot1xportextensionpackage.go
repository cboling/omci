...
func init() {
	dot1xportextensionpackageBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("Dot1XEnable", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 1),
			2:  ByteField("ActionRegister", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Write), false, false, 2),
			3:  ByteField("AuthenticatorPaeState", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 3),
			4:  ByteField("BackendAuthenticationState", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 4),
			5:  ByteField("AdminControlledDirections", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 5),
			6:  ByteField("OperationalControlledDirections", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 6),
			7:  ByteField("AuthenticatorControlledPortStatus", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 7),
			8:  Uint16Field("QuietPeriod", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 8),
			9:  Uint16Field("ServerTimeoutPeriod", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 9),
			10: Uint16Field("ReAuthenticationPeriod", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 10),
			11: ByteField("ReAuthenticationEnabled", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 11),
			12: ByteField("KeyTransmissionEnabled", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, 12),
		},
		Access:  CreatedByOnu,
