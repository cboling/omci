...
func init() {
	managedentitymeBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2: TableField("AttributesTable", TableAttributeType, TableInfo{nil, 2}, mapset.NewSetWith(Read), false, false, 2),
			3: ByteField("Access", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: TableField("AlarmsTable", TableAttributeType, TableInfo{nil, 1}, mapset.NewSetWith(Read), false, false, 4),
			5: TableField("AvcsTable", TableAttributeType, TableInfo{nil, 1}, mapset.NewSetWith(Read), false, false, 5),
			6: Uint32Field("Actions", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7: TableField("InstancesTable", TableAttributeType, TableInfo{nil, 2}, mapset.NewSetWith(Read), false, false, 7),
			8: ByteField("Support", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
		},
		Access:  CreatedByOnu,
