...
func init() {
	enhancedfecperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			6: Uint64Field("TotalCodeWords", 0, mapset.NewSetWith(Read), false, false, false, false, 6),
			7: Uint16Field("FecSeconds", 0, mapset.NewSetWith(Read), false, false, false, false, 7),
		},
