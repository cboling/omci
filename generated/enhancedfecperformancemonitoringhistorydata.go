...
func init() {
	enhancedfecperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint64Field("CorrectedBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint64Field("CorrectedCodeWords", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: Uint64Field("UncorrectableCodeWords", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6: Uint64Field("TotalCodeWords", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7: Uint16Field("FecSeconds", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
		},
		Access:  CreatedByOlt,
