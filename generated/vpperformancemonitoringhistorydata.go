...
func init() {
	vpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			6: MultiByteField("TransmittedC=01Cells", CounterAttributeType, 5, nil, mapset.NewSetWith(Read), false, false, false, 6),
			7: MultiByteField("TransmittedC=0Cells", CounterAttributeType, 5, nil, mapset.NewSetWith(Read), false, false, false, 7),
