...
func init() {
	vpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint16Field("LostC01Cells", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint16Field("LostC=0Cells", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: Uint16Field("MisinsertedCells", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6: MultiByteField("TransmittedC=01Cells", CounterAttributeType, 5, toOctets("AAAAAAA="), mapset.NewSetWith(Read), false, false, false, 6),
			7: MultiByteField("TransmittedC=0Cells", CounterAttributeType, 5, toOctets("AAAAAAA="), mapset.NewSetWith(Read), false, false, false, 7),
			8: Uint16Field("ImpairedBlock", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
		},
		Access:  CreatedByOlt,
