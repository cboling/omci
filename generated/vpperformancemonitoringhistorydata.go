...
func init() {
	vpperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint16Field("LostC01Cells", 0, mapset.NewSetWith(Read), false, false, false, 3),
			4: Uint16Field("LostC=0Cells", 0, mapset.NewSetWith(Read), false, false, false, 4),
			5: Uint16Field("MisinsertedCells", 0, mapset.NewSetWith(Read), false, false, false, 5),
			6: MultiByteField("TransmittedC=01Cells", 5, nil, mapset.NewSetWith(Read), false, false, false, 6),
			7: MultiByteField("TransmittedC=0Cells", 5, nil, mapset.NewSetWith(Read), false, false, false, 7),
			8: Uint16Field("ImpairedBlock", 0, mapset.NewSetWith(Read), false, false, false, 8),
		},
	}
}
