...
func init() {
	pwatmconfigurationdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2: Uint16Field("TransportTpPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3: Uint16Field("PptpAtmUniPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 3),
			4: Uint16Field("MaxCEllCOncatenation", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5: Uint16Field("FarEndMAxCEllCOncatenation", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 5),
			6: ByteField("AtmCellLossPriorityClpQosMapping", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 6),
			7: ByteField("TimeoutMode", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 7),
			8: TableField("PwAtmMappingTable", TableAttributeType, TableInfo{nil, 21}, mapset.NewSetWith(Read, Write), false, false, 8),
		},
		Access:  CreatedByOlt,
