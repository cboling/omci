...
func init() {
	pwatmconfigurationdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2: Uint16Field("TransportTpPointer", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, false, 2),
			3: Uint16Field("PptpAtmUniPointer", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, false, 3),
			4: Uint16Field("MaxCEllCOncatenation", 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, false, 4),
