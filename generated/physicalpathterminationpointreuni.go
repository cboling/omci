...
func init() {
	physicalpathterminationpointreuniBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			5:  Uint16Field("ReAniGPointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 5),
			6:  TableField("TotalOpticalReceiveSignalLevelTable", TableAttributeType, TableInfo{nil, 4}, mapset.NewSetWith(Read), false, true, false, 6),
			7:  TableField("PerBurstReceiveSignalLevelTable", TableAttributeType, TableInfo{nil, 4}, mapset.NewSetWith(Read), false, true, false, 7),
			8:  ByteField("LowerReceiveOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 8),
			9:  ByteField("UpperReceiveOpticalThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 9),
			10: Uint16Field("TransmitOpticalLevel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 10),
			11: ByteField("LowerTransmitPowerThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 11),
			12: ByteField("UpperTransmitPowerThreshold", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 12),
			13: ByteField("ADditionalPreamble", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 13),
			14: ByteField("ADditionalGuardTime", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 14),
		},
		Access:  CreatedByOnu,
