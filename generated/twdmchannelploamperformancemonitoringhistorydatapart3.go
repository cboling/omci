...
func init() {
	twdmchannelploamperformancemonitoringhistorydatapart3BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("UpstreamPloamMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4:  Uint32Field("SerialNumberOnuInBandMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5:  Uint32Field("SerialNumberOnuAmccMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint32Field("RegistrationMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("KeyReportMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint32Field("AcknowledgementMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint32Field("SleepRequestMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("TuningResponseAckNackMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint32Field("TuningResponseCompleteURollbackMessageCount", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
