...
func init() {
	twdmchannelploamperformancemonitoringhistorydatapart3BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("UpstreamPloamMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4:  Uint32Field("SerialNumberOnuInBandMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  Uint32Field("SerialNumberOnuAmccMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  Uint32Field("RegistrationMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint32Field("KeyReportMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  Uint32Field("AcknowledgementMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
			9:  Uint32Field("SleepRequestMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint32Field("TuningResponseAckNackMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: Uint32Field("TuningResponseCompleteURollbackMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 11),
			12: Uint32Field("PowerConsumptionReportMessageCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 12),
			13: Uint32Field("ChangePowerLevelParameterErrorCount", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 13),
		},
		Access:  CreatedByOlt,
