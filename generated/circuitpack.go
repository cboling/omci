...
func init() {
	circuitpackBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  MultiByteField("SerialNumber", 8, toOctets("ICAgICAgICA="), mapset.NewSetWith(Read), false, false, false, false, 3),
			4:  MultiByteField("Version", 14, toOctets("ICAgICAgICAgICAgICA="), mapset.NewSetWith(Read), false, false, false, false, 4),
			5:  MultiByteField("VendorId", 4, toOctets("ICAgIA=="), mapset.NewSetWith(Read), false, false, true, false, 5),
			6:  ByteField("AdministrativeState", 0, mapset.NewSetWith(Read, Write), false, false, false, false, 6),
			7:  ByteField("OperationalState", 2, mapset.NewSetWith(Read), true, false, true, false, 7),
			8:  ByteField("BridgedOrIpInd", 0, mapset.NewSetWith(Read, Write), false, false, false, false, 8),
			9:  MultiByteField("EquipmentId", 20, toOctets("ICAgICAgICAgICAgICAgICAgICA="), mapset.NewSetWith(Read), false, false, true, false, 9),
