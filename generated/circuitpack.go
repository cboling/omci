...
func init() {
	circuitpackBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  ByteField("Type", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate), false, false, false, 1),
			2:  ByteField("NumberOfPorts", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 2),
			3:  MultiByteField("SerialNumber", OctetsAttributeType, 8, toOctets("ICAgICAgICA="), mapset.NewSetWith(Read), false, false, false, 3),
			4:  MultiByteField("Version", OctetsAttributeType, 14, toOctets("ICAgICAgICAgICAgICA="), mapset.NewSetWith(Read), false, false, false, 4),
			5:  MultiByteField("VendorId", StringAttributeType, 4, toOctets("ICAgIA=="), mapset.NewSetWith(Read), false, true, false, 5),
			6:  ByteField("AdministrativeState", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 6),
			7:  ByteField("OperationalState", EnumerationAttributeType, 2, mapset.NewSetWith(Read), true, true, false, 7),
			8:  ByteField("BridgedOrIpInd", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 8),
			9:  MultiByteField("EquipmentId", StringAttributeType, 20, toOctets("ICAgICAgICAgICAgICAgICAgICA="), mapset.NewSetWith(Read), false, true, false, 9),
			10: ByteField("CardConfiguration", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, 10),
			11: ByteField("TotalTContBufferNumber", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 11),
			12: ByteField("TotalPriorityQueueNumber", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 12),
			13: ByteField("TotalTrafficSchedulerNumber", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 13),
			14: Uint32Field("PowerShedOverride", BitFieldAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 14),
		},
		Access:  CreatedByOlt,
