...
func init() {
	dot1agdefaultmdlevelBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("Layer2Type", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, 1),
			2: ByteField("CatchallLevel", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
			3: ByteField("CatchallMhfCreation", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4: ByteField("CatchallSenderIdPermission", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 4),
			5: TableField("DefaultMdLevelTable", TableAttributeType, TableInfo{nil, 29}, mapset.NewSetWith(Read, Write), false, false, 5),
		},
		Access:  CreatedByOnu,
