...
func init() {
	softwareimageBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("Version", StringAttributeType, 14, toOctets("ICAgICAgICAgICAgICAgICAgICA="), mapset.NewSetWith(Read), true, false, false, 1),
			2: ByteField("IsCommitted", EnumerationAttributeType, 0, mapset.NewSetWith(Read), true, false, false, 2),
			3: ByteField("IsActive", EnumerationAttributeType, 0, mapset.NewSetWith(Read), true, false, false, 3),
			4: ByteField("IsValid", EnumerationAttributeType, 0, mapset.NewSetWith(Read), true, false, false, 4),
			5: MultiByteField("ProductCode", OctetsAttributeType, 25, toOctets("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=="), mapset.NewSetWith(Read), true, true, false, 5),
			6: MultiByteField("ImageHash", StringAttributeType, 16, toOctets("AAAAAAAAAAAAAAAAAAAAAA=="), mapset.NewSetWith(Read), true, true, false, 6),
		},
		Access:  CreatedByOnu,
