...
func init() {
	ethernetperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("FcsErrors", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4:  Uint32Field("ExcessiveCollisionCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5:  Uint32Field("LateCollisionCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6:  Uint32Field("FramesTooLong", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("BufferOverflowsOnReceive", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint32Field("BufferOverflowsOnTransmit", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint32Field("SingleCollisionFrameCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("MultipleCollisionsFrameCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint32Field("SqeCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
			12: Uint32Field("DeferredTransmissionCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 12),
			13: Uint32Field("InternalMacTransmitErrorCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 13),
			14: Uint32Field("CarrierSenseErrorCounter", 0, mapset.NewSetWith(Read), false, true, false, false, 14),
