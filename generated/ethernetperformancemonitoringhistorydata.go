...
func init() {
	ethernetperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  Uint32Field("FcsErrors", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4:  Uint32Field("ExcessiveCollisionCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  Uint32Field("LateCollisionCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  Uint32Field("FramesTooLong", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint32Field("BufferOverflowsOnReceive", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  Uint32Field("BufferOverflowsOnTransmit", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
			9:  Uint32Field("SingleCollisionFrameCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint32Field("MultipleCollisionsFrameCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: Uint32Field("SqeCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 11),
			12: Uint32Field("DeferredTransmissionCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 12),
			13: Uint32Field("InternalMacTransmitErrorCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 13),
			14: Uint32Field("CarrierSenseErrorCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 14),
			15: Uint32Field("AlignmentErrorCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 15),
			16: Uint32Field("InternalMacReceiveErrorCounter", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 16),
		},
		Access:  CreatedByOlt,
