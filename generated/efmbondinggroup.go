...
func init() {
	efmbondinggroupBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("GroupId", 6, nil, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, false, 1),
			2: Uint32Field("MinimumUpstreamGroupRate", 0, mapset.NewSetWith(Read, Write), false, false, false, false, 2),
