...
func init() {
	efmbondinggroupBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: MultiByteField("GroupId", OctetsAttributeType, 6, nil, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2: Uint32Field("MinimumUpstreamGroupRate", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 2),
			3: Uint32Field("MinimumDownstreamGroupRate", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, 3),
			4: ByteField("GroupAlarmEnable", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
		},
		Access:  CreatedByOlt,
