...
func init() {
	ethernetframeextendedpmBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2:  MultiByteField("ControlBlock", OctetsAttributeType, 16, toOctets("AAAAAAAAAAAAAAAAAAAAAA=="), mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3:  Uint32Field("DropEvents", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4:  Uint32Field("Octets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5:  Uint32Field("Frames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6:  Uint32Field("BroadcastFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7:  Uint32Field("MulticastFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8:  Uint32Field("CrcErroredFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
			9:  Uint32Field("UndersizeFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 9),
			10: Uint32Field("OversizeFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 10),
			11: Uint32Field("Frames64Octets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 11),
			12: Uint32Field("Frames65To127Octets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 12),
			13: Uint32Field("Frames128To255Octets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 13),
			14: Uint32Field("Frames256To511Octets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 14),
			15: Uint32Field("Frames512To1023Octets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 15),
			16: Uint32Field("Frames1024To1518Octets", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 16),
		},
		Access:  CreatedByOlt,
