...
func init() {
	ethernetframeextendedpmBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			6:  Uint32Field("BroadcastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
			7:  Uint32Field("MulticastFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 7),
			8:  Uint32Field("CrcErroredFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 8),
			9:  Uint32Field("UndersizeFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 9),
			10: Uint32Field("OversizeFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 10),
			11: Uint32Field("Frames64Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 11),
			12: Uint32Field("Frames65To127Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 12),
			13: Uint32Field("Frames128To255Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 13),
			14: Uint32Field("Frames256To511Octets", 0, mapset.NewSetWith(Read), false, true, false, false, 14),
