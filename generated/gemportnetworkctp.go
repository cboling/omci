...
func init() {
	gemportnetworkctpBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  Uint16Field("PortId", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 1),
			2:  Uint16Field("TContPointer", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 2),
			3:  ByteField("Direction", EnumerationAttributeType, 3, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 3),
			4:  Uint16Field("TrafficManagementPointerForUpstream", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 4),
			5:  Uint16Field("TrafficDescriptorProfilePointerForUpstream", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 5),
			6:  ByteField("UniCounter", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, 6),
			7:  Uint16Field("PriorityQueuePointerForDownStream", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, false, 7),
			8:  ByteField("EncryptionState", EnumerationAttributeType, 0, mapset.NewSetWith(Read), false, true, 8),
			9:  Uint16Field("TrafficDescriptorProfilePointerForDownstream", PointerAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 9),
			10: ByteField("EncryptionKeyRing", EnumerationAttributeType, 0, mapset.NewSetWith(Read, SetByCreate, Write), false, true, 10),
		},
		Access:  CreatedByOlt,
