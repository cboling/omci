...
func NewGemPortNetworkCtp(params ...ParamData) (IManagedEntityDefinition, error) {
	...
	entity := BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2:  Uint16Field("TContPointer", 0, Read|SetByCreate|Write),
			3:  ByteField("Direction", 0, Read|SetByCreate|Write),
			4:  Uint16Field("TrafficManagementPointerForUpstream", 0, Read|SetByCreate|Write),
			5:  Uint16Field("TrafficDescriptorProfilePointerForUpstream", 0, Read|SetByCreate|Write),
			6:  ByteField("UniCounter", 0, Read),
			7:  Uint16Field("PriorityQueuePointerForDownStream", 0, Read|SetByCreate|Write),
			8:  ByteField("EncryptionState", 0, Read),
			9:  Uint16Field("TrafficDescriptorProfilePointerForDownstream", 0, Read|SetByCreate|Write),
			10: ByteField("EncryptionKeyRing", 0, Read|SetByCreate|Write),
		},
	}
