...
func init() {
	cardholderBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1: ByteField("ActualPlugInUnitType", EnumerationAttributeType, 0, mapset.NewSetWith(Read), true, false, false, 1),
			2: ByteField("ExpectedPlugInUnitType", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, false, false, 2),
			3: ByteField("ExpectedPortCount", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 3),
			4: MultiByteField("ExpectedEquipmentId", StringAttributeType, 20, toOctets("ICAgICAgICAgICAgICAgICAgICA="), mapset.NewSetWith(Read, Write), false, true, false, 4),
			5: MultiByteField("ActualEquipmentId", StringAttributeType, 20, toOctets("ICAgICAgICAgICAgICAgICAgICA="), mapset.NewSetWith(Read), true, true, false, 5),
			6: ByteField("ProtectionProfilePointer", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 6),
			7: ByteField("InvokeProtectionSwitch", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), false, true, false, 7),
			8: ByteField("AlarmReportingControl", EnumerationAttributeType, 0, mapset.NewSetWith(Read, Write), true, true, false, 8),
