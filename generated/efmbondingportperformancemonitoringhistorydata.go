...
func init() {
	efmbondingportperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("RxFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint32Field("TxFrames", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5: Uint32Field("RxBytes", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6: Uint32Field("TxBytes", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
