...
func init() {
	efmbondingportperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("RxFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 3),
			4: Uint32Field("TxFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 4),
			5: Uint32Field("RxBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 5),
			6: Uint32Field("TxBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 6),
			7: Uint32Field("TxDiscardedFrames", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 7),
			8: Uint32Field("TxDiscardedBytes", CounterAttributeType, 0, mapset.NewSetWith(Read), false, false, 8),
		},
		Access:  CreatedByOlt,
