...
func init() {
	xdslimpulsenoisemonitorperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: TableField("InmInpeqHistogramTable", TableAttributeType, TableInfo{nil, 2}, mapset.NewSetWith(Read), false, true, false, 3),
			4: Uint16Field("InmTotalMeasurement", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 4),
			5: Uint16Field("InmIatHistogram", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 5),
			6: TableField("InmInpeqHistogramLfeTable", TableAttributeType, TableInfo{nil, 2}, mapset.NewSetWith(Read), false, true, false, 6),
			7: Uint16Field("InmTotalMeasurementLfe", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 7),
			8: Uint16Field("InmIatHistogramLfe", CounterAttributeType, 0, mapset.NewSetWith(Read), false, true, false, 8),
		},
		Access:  CreatedByOlt,
