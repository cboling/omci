...
func init() {
	radiusperformancemonitoringhistorydataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3: Uint32Field("AccessRequestPacketsTransmitted", 0, mapset.NewSetWith(Read), false, true, false, false, 3),
			4: Uint32Field("AccessRequestRetransmissionCount", 0, mapset.NewSetWith(Read), false, true, false, false, 4),
			5: Uint32Field("AccessChallengePacketsReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 5),
			6: Uint32Field("AccessAcceptPacketsReceived", 0, mapset.NewSetWith(Read), false, true, false, false, 6),
