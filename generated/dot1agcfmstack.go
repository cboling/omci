...
func init() {
	dot1agcfmstackBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			2: TableField("MpStatusTable", TableAttributeType, TableInfo{nil, 18}, mapset.NewSetWith(Read), false, false, 2),
			3: TableField("ConfigurationErrorListTable", TableAttributeType, TableInfo{nil, 5}, mapset.NewSetWith(Read), true, false, 3),
		},
		Access:  CreatedByOnu,
