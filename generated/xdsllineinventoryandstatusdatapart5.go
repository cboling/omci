...
func init() {
	xdsllineinventoryandstatusdatapart5BME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  Uint16Field("FextDownstreamSnrMargin", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 1),
			2:  Uint16Field("NextDownstreamSnrMargin", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 2),
			3:  Uint16Field("FextUpstreamSnrMargin", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 3),
			4:  Uint16Field("NextUpstreamSnrMargin", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 4),
			5:  Uint32Field("FextDownstreamMaximumAttainableDataRate", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 5),
			6:  Uint32Field("NextDownstreamMaximumAttainableDataRate", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 6),
			7:  Uint32Field("FextUpstreamMaximumAttainableDataRate", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 7),
			8:  Uint32Field("NextUpstreamMaximumAttainableDataRate", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 8),
			9:  Uint16Field("FextDownstreamActualPowerSpectralDensity", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 9),
			10: Uint16Field("NextDownstreamActualPowerSpectralDensity", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 10),
			11: Uint16Field("FextUpstreamActualPowerSpectralDensity", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 11),
			12: Uint16Field("NextUpstreamActualPowerSpectralDensity", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 12),
			13: Uint16Field("FextDownstreamActualAggregateTransmitPower", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 13),
			14: Uint16Field("NextDownstreamActualAggregateTransmitPower", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 14),
			15: Uint16Field("FextUpstreamActualAggregateTransmitPower", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 15),
			16: Uint16Field("NextUpstreamActualAggregateTransmitPower", UnsignedIntegerAttributeType, 0, mapset.NewSetWith(Read), false, false, false, 16),
		},
		Access:  CreatedByOnu,
