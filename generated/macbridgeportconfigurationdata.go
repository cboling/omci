...
func NewMacBridgePortConfigurationData(params ...ParamData) (IManagedEntityDefinition, error) {
	...
	entity := BaseManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			1:  Uint16Field("BridgeIdPointer", 0, Read|SetByCreate|Write),
			2:  ByteField("PortNum", 0, Read|SetByCreate|Write),
			3:  ByteField("TpType", 0, Read|SetByCreate|Write),
			4:  Uint16Field("TpPointer", 0, Read|SetByCreate|Write),
			5:  Uint16Field("PortPriority", 0, Read|SetByCreate|Write),
			6:  Uint16Field("PortPathCost", 0, Read|SetByCreate|Write),
			7:  ByteField("PortSpanningTreeInd", 0, Read|SetByCreate|Write),
			8:  ByteField("Deprecated1", 0, Read|SetByCreate|Write),
			9:  ByteField("Deprecated2", 0, Read|SetByCreate|Write),
			...
			13: ByteField("MacLearningDepth", 0, Read|SetByCreate|Write),
		},
	}
