...
func init() {
	macbridgeportconfigurationdataBME = &ManagedEntityDefinition{
		...
		AttributeDefinitions: AttributeDefinitionMap{
			...
			3:  ByteField("TpType", 1, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, false, 3),
			...
			6:  Uint16Field("PortPathCost", 1, mapset.NewSetWith(Read, SetByCreate, Write), false, false, false, false, 6),
			...
			10: MultiByteField("PortMacAddress", 6, toOctets("AAAAAAAA"), mapset.NewSetWith(Read), false, false, true, false, 10),
