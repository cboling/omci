...
var (
	...
	LayerTypeUnknownAlarm      gopacket.LayerType
)
...
func init() {
	...
	decode = decodeUnknownAlarms
	LayerTypeUnknownAlarm = gopacket.RegisterLayerType(2002,
		gopacket.LayerTypeMetadata{Name: "Unknown Alarm", Decoder: decode})
}
